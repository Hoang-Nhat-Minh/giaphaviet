...
FamilyTree._defaultConfig = function (e) {
        ...
        if (!a.notifierUI.show(null)) {
          ...
          if (FamilyTree.RENDER_LINKS_BEFORE_NODES)
            for (var m = 0; m < e.visibleNodeIds.length; m++) {
              ...
              FamilyTree.getRootOf(h).stParent ? c.push(h.id) : o += a.ui.link(h, a, l, e.bordersByRootIdAndLevel, e.nodes, t)
            }
          for (m = 0; m < e.visibleNodeIds.length; m++) {
            h = e.nodes[e.visibleNodeIds[m]];
            var p = a._get(h.id);
            FamilyTree.RENDER_LINKS_BEFORE_NODES && c.includes(h.id) && (o += a.ui.link(h, a, l, e.bordersByRootIdAndLevel, e.nodes, t)), o += a.ui.node(h, p, e.animations, a.config, void 0, void 0, void 0, t, l, a)
          }
          for (m = 0; m < e.visibleNodeIds.length; m++) {
            h = e.nodes[e.visibleNodeIds[m]];
            FamilyTree.RENDER_LINKS_BEFORE_NODES || (o += a.ui.link(h, a, l, e.bordersByRootIdAndLevel, e.nodes, t)), o += a.ui.expandCollapseBtn(a, h, a._layoutConfigs, t, l)
          }
          n = {
            content: o,
            res: e
          ...
          if (FamilyTree.events.publish("render", [a, n]), o = n.content, e = n.res, o += a.ui.lonely(a.config), t !== FamilyTree.action.exporting) {
            ...
            if (a._initialized) {
              var f = a.getSvg(),
                u = f.parentNode;
              u.removeChild(f), u.insertAdjacentHTML("afterbegin", F), a._attachEventHandlers(), a.xScrollUI.addListener(a.getSvg()), a.yScrollUI.addListener(a.getSvg()), a.xScrollUI.setPosition(), a.yScrollUI.setPosition()
            ...
            if (g[0].length > 0) {
              ...
              FamilyTree.animate(g[0], g[1], g[2], a.config.anim.duration, a.config.anim.func, (function () {
                y || (r && r(), FamilyTree.events.publish("redraw", [a]), a._showAfterAnimation(), y = !0)
              }))
            }
            t === FamilyTree.action.centerNode ? FamilyTree.animate(a.getSvg(), {
              ...
              a.ripple(i.options.rippleId), y || (r && r(), FamilyTree.events.publish("redraw", [a]), a._showAfterAnimation(), y = !0)
            }), (function () {
              ...
              a.xScrollUI.setPosition(), a.yScrollUI.setPosition(), y || (r && r(), FamilyTree.events.publish("redraw", [a]), y = !0)
  ...
  else switch (v = firstRoot.x - y / 2 + FamilyTree.manager._getNodeWidth(firstRoot, this.config) / 2, this.config.orientation) {
  ...
  else switch ((T = -(g / 2 - (o - s) / 2)) > -this.config.padding && (T = -this.config.padding), this.config.orientation) {
  ...
  var i = this;
  return this.config.nodes = e, this.config.roots = null, this._draw(!1, FamilyTree.action.init, void 0, (function () {
    i.filterUI.update(), t && t()
  })), this
  ...
  if (null == e.id && console.error("Call addNode without id"), this._putInUndoStack(), this.clearRedo(), this.config.movable && !FamilyTree.isNEU(e.pid)) {
  ...
  if (Array.isArray(this.config.roots))
    for (i = 0; i < this.config.roots.length; i++) FamilyTree.isNEU(e[this.config.roots[i]]) || (this.config.roots[i] = e[this.config.roots[i]]);
  if (this.nodes)
  ...
  if (!FamilyTree.isNEU(t) && t.length)
    if (i) {
      ...
      var h = "";
      d && (h = d.id), n._draw(!1, FamilyTree.action.update, {
        id: h
      }, (function () {
  ...
  return Array.isArray(e) || (e = [e]), Array.isArray(t) || (t = [t]), Array.isArray(i) || (i = [i]), l = setInterval((function () {
    for (var m = 0; m < e.length; m++)
      for (var h in i[m]) {
        var p = FamilyTree._arrayContains(["top", "left", "right", "bottom", "width", "height"], h.toLowerCase()) ? "px" : "";
        switch (h.toLowerCase()) {
          case "d":
            var f = a((d * s - s) / r) * (i[m][h][0] - t[m][h][0]) + t[m][h][0],
              u = a((d * s - s) / r) * (i[m][h][1] - t[m][h][1]) + t[m][h][1];
  ...
  var l, s, d, c = t.p,
    ...
    h = t.r,
    p = t.s;
  return 0 !== (l = (n - r) * (p - m) - (h - c) * (o - a)) && (s = ((a - o) * (h - r) + (n - r) * (p - a)) / l, 0 < (d = ((p - m) * (h - r) + (c - h) * (p - a)) / l) && d < 1 && 0 < s && s < 1)
  ...
  FamilyTree.isNEU(e) ? t.innerHTML = FamilyTree.icon.user(150, 150, "#8C8C8C", 0, 0) : t.innerHTML = `<img style="width: 100%;height:100%;object-fit:cover;border-radius: 50%;" src="${e}"></img>`
  ...
  FamilyTree.isNEU(g) && (g = ""), v = FamilyTree.isNEU(v) ? FamilyTree.icon.user(150, 150, "#8C8C8C", 0, 0) : `<img style="width: 100%;height:100%;border-radius: 50%;object-fit:cover;" src="${v}"></img>`;
  var w = !t,
    k = t ? "display:none;" : "",
    S = t || !s ? "display:none;" : "",
    C = y.editFormHeaderColor ? `style="background-color:${y.editFormHeaderColor};"` : "",
    I = document.createElement("form");
  if (I.setAttribute("data-bft-edit-form", ""), I.classList.add("bft-edit-form"), I.classList.add(this.obj.config.mode), I.classList.add(f.templateName.replaceAll(" ", "")), I.classList.add(FamilyTree.ui._defsIds[f.templateName]), Array.isArray(f.tags) && f.tags.length)
    for (T = 0; T < f.tags.length; T++) I.classList.add(f.tags[T].replaceAll(" ", ""));
  ...
  return I.innerHTML = `<div>\n                        <div class="bft-edit-form-header" ${C}>\n                            ${A}\n                            ${FamilyTree.editUI.renderHeaderContent(g, v, f, u)}\n                        </div>\n                        <div data-bft-edit-from-btns class="bft-edit-form-instruments">\n                        ${function () { if (a) return ""; var e = ""; for (var i in m) { var r = m[i]; FamilyTree.isNEU(r) || (w && r.hideIfEditMode || t && r.hideIfDetailsMode || o && "Edit" == r.text || (e += `<div data-edit-from-btn='${i}' class="bft-img-button" ${C} title="${r.text}">${r.icon}</div>`)) } return e }()}    \n                        </div>\n                    </div>\n                    <div class="bft-edit-form-fields">\n                        <div class="bft-edit-form-fields-inner">\n                            <div class="bft-form-fieldset">\n                                ${function () {
    for (var e = "", i = 0; i < l.length; i++) {
      var r = l[i]; if (Array.isArray(r)) { e += '<div class="bft-form-field-100 bft-form-fieldset">'; for (var a = 0; a < r.length; a++) { var o = r[a], s = FamilyTree.elements[o.type](u, o, "unset", t); !FamilyTree.isNEU(s.id) && FamilyTree.isNEU(n) && FamilyTree.isNEU(s.value) && (n = s.id), FamilyTree.isNEU(s.value) || N.push(`${o.label}: ${s.value}`), e += s.html } e += "</div>" } else {
        s = FamilyTree.elements[r.type](u, r, "280px", t); !FamilyTree.isNEU(s.id) && FamilyTree.isNEU(n) && FamilyTree.isNEU(s.value) && (n = s.id), FamilyTree.isNEU(s.value) || N.push(`
    $ {
        r.label
    }: $ {
        s.value
  ...
  if ("" != o) {
    ...
    var h = e + 45;
    this.wrapper.style.left = h + "px", this.wrapper.style.top = t + "px", this.wrapper.style.left = h - this.wrapper.offsetWidth + "px";
  ...
  if (!FamilyTree.isNEU(a.nodeCircleMenuButton)) {
    var n = this.obj.getSvg(),
      ...
      p = this.obj.element.querySelector("[" + FamilyTree.attr.control_node_circle_menu_wrraper_id + "]");
    if (FamilyTree.isNEU(p) || p.getAttribute(FamilyTree.attr.control_node_circle_menu_wrraper_id) != e) {
      ...
      for (var F in (p = document.createElementNS("http://www.w3.org/2000/svg", "g")).setAttribute(FamilyTree.attr.control_node_circle_menu_wrraper_id, e), p.setAttribute("transform", "matrix(1,0,0,1," + c + "," + m + ")"), n.appendChild(p), f.menu) {
        var x = f.menu[F].icon,
          _ = f.menu[F].color,
          w = f.menu[F].text;
        ...
        C.setAttribute("cx", 0), C.setAttribute("cy", 0), C.setAttribute("r", a.nodeCircleMenuButton.radius), C.setAttribute("fill", _), C.setAttribute("stroke-width", "1"), C.setAttribute("stroke", a.nodeCircleMenuButton.stroke), k.appendChild(C), k.appendChild(S), k.innerHTML += x, p.appendChild(k);
      ...
      this._linesInterval.push(FamilyTree.animate(h[0], {
        ...
        x2: 7,
        y2: 7
      }, 500, FamilyTree.anim.inOutSin)), this._linesInterval.push(FamilyTree.animate(h[1], {
        x1: -a.nodeCircleMenuButton.radius / 2,
        y1: 0,
        x2: a.nodeCircleMenuButton.radius / 2,
        y2: 0
        ...
        x2: 0,
        y2: 0
      }, 500, FamilyTree.anim.inOutSin)), this._linesInterval.push(FamilyTree.animate(h[2], {
        x1: -a.nodeCircleMenuButton.radius / 2,
        y1: 6,
        x2: a.nodeCircleMenuButton.radius / 2,
        y2: 6
    ...
    i && i.addEventListener("click", (function () {
      ...
      for (var t = e.target; t;) {
        if (t.hasAttribute && t.hasAttribute(FamilyTree.attr.layout)) {
          t = t.getAttribute(FamilyTree.attr.layout), l.obj.setLayout(FamilyTree.layout[t]);
          break
        }
        t = t.parentNode
      }
  ...
  if (c = parseFloat(c), l || (l = 0), s || (s = 0), l || (d = "start"), "ellipsis" == m) {
    ...
    for (var u = p.getComputedTextLength(), y = 2; u > c;) p.textContent = e.substring(0, e.length - y), p.textContent += "...", u = p.getComputedTextLength(), y++;
    return y > 2 ? `<title>${FamilyTree._escapeHtml(e)}</title>${p.textContent}` : FamilyTree._escapeHtml(e)
  }
  if (-1 != m.indexOf("multiline")) {
    ...
    T.setAttributeNS(null, "x", l), T.setAttributeNS(null, "y", s), T.setAttributeNS(null, "text-anchor", d), T.appendChild(b), p.appendChild(T);
    y = 1;
    for (var F = 1, x = !1, _ = 1; _ < g.length; _++) {
      var w = T.firstChild.data.length;
      if (T.firstChild.data += " " + g[_], T.getComputedTextLength() > c) {
        if (T.firstChild.data = T.firstChild.data.slice(0, w), F++, a && F > a) {
          if (n && p.children.length == a) {
            var k = p.children[a - 1].textContent;
            p.children[a - 1].textContent = k.substring(0, k.length - 3) + "...", x = !0
          }
          break
        } (T = document.createElementNS(h, "tspan")).setAttributeNS(null, "x", l), T.setAttributeNS(null, "y", s + v * y), T.setAttributeNS(null, "text-anchor", d), b = document.createTextNode(g[_]), T.appendChild(b), p.appendChild(T), y++
      }
    }
    var S = "";
    if (null != p.innerHTML) S = p.innerHTML, p.innerHTML = "";
      ...
      var C = "";
      for (_ = p.childNodes.length - 1; _ >= 0; _--) C = XMLSerializer().serializeToString(p.childNodes[_]) + C, p.removeChild(p.childNodes[_]);
      S = C
    }
  ...
  if (e.length > 1) {
    ...
    for (var c = 1; c < e.length; c++) {
      var m = l[l.length - 1],
        h = e[c],
        p = h == d ? e[1] : e[c + 1];
      if (p && m && m.length > 2 && "L" == h[0] && p.length > 2 && "L" == p[0]) {
        var f, u, y = o(m),
          g = o(h),
          v = o(p);
        i ? (f = a(g, m.origPoint || y, t), u = a(g, p.origPoint || v, t)) : (f = r(g, y, t), u = r(g, v, t)), n(h, f), h.origPoint = g, l.push(h);
        var T = a(f, g, .5),
          b = a(g, u, .5),
  ...
  e.margin && e.margin[0] < 2 && (e.margin[0] = 2), e.margin && e.margin[1] < 2 && (e.margin[1] = 2), e.margin && e.margin[2] < 2 && (e.margin[2] = 2), e.margin && e.margin[3] < 2 && (e.margin[3] = 2), this._draw(!1, FamilyTree.action.exporting, r, (function (r, a) {
    var n = document.createElement("div");
    if (n.innerHTML = r, e.padding > 0) {
      var o = n.querySelector("svg"),
        l = FamilyTree._getViewBox(o);
      l[0] -= e.padding, l[1] -= e.padding, l[2] += 2 * e.padding, l[3] += 2 * e.padding, o.setAttribute("viewBox", l.join()), o.setAttribute("width", l[2]), o.setAttribute("height", l[3])
    }
    if ("svg" == e.ext)
      if (t) t(e, n.innerHTML);
        ...
        if (c && (s.styles += c.outerHTML), s.styles && (n.childNodes[0].insertAdjacentHTML("afterbegin", s.styles), s.content = n.innerHTML), !1 === d) return !1;
        if (!1 === (d = FamilyTree.events.publish("exportend", [i, s]))) return !1;
        FamilyTree._downloadFile(e.mime, s.content, s.options.filename, s.options.openInNewTab, s.options.ext)
      }
    else i._pages(e, n.querySelector("svg"), a, (function (r) {
      var a = {
        content: n.innerHTML,
        options: e,
        pages: r,
      ...
      t || FamilyTree.loading.show(i), t ? t(i, a, n.querySelector("svg")) : (a = JSON.stringify(a), FamilyTree._ajax(i.config.exportUrl + "/v3", "POST", a, "arraybuffer", (function (t) {
  ...
  var o = e.landscape ? n - (e.margin[1] + e.margin[3]) : a - (e.margin[1] + e.margin[3]),
    l = (e.landscape ? (e.margin[0], e.margin[2]) : (e.margin[0], e.margin[2]), o / r);
  ...
  var l = a[0],
    ...
    c = a[3],
    m = {
      w: e.landscape ? o - (e.margin[1] + e.margin[3]) : n - (e.margin[1] + e.margin[3]),
      h: e.landscape ? n - (e.margin[0] + e.margin[2]) : o - (e.margin[0] + e.margin[2])
    },
    h = {
      w: e.landscape ? o : n,
      h: e.landscape ? n : o
  ...
  if (!FamilyTree.EXPORT_PAGES_CUT_NODES && "fit" == e.scale) {
    ...
    for (var T = Object.keys(r.bordersByRootIdAndLevel), b = r.bordersByRootIdAndLevel[T[0]], F = Object.keys(b).length, x = 1; x < T.length; x++) F < Object.keys(r.bordersByRootIdAndLevel[T[x]]).length && (b = r.bordersByRootIdAndLevel[T[x]], F = Object.keys(b).length);
    for (var _ = 0, w = 0; ;) {
      for (w = _; !(F <= _);) {
        ...
        if (_ == F - 1 && (k = (b[_].maxY - b[w].minY) / (100 / i)), k > m.h) break;
        _++
      }
      if (!v) break;
      ...
      if (C = (C = [u, b[w].minY, p, S]).join(), g.push({
        vb: C,
        innerSize: {
          w: m.x,
          h: S / (100 / i) - 1
  ...
  if (!v || FamilyTree.EXPORT_PAGES_CUT_NODES || "fit" != e.scale)
    for (t.setAttribute("preserveAspectRatio", "xMinYMin slice"), g = []; u < d + l;) {
      for (; y < c + s;) {
        var C;
        C = (C = [u, y, p, f]).join(), g.push({
          vb: C,
          innerSize: m,
          size: h
        }), y += f
  ...
  if (-1 == e.indexOf("id") || -1 == e.indexOf("pid")) {
    ...
    h.id = "bft-id-select", h.style.fontSize = "16px", h.style.color = "rgb(122, 122, 122)", h.style.padding = "5px", h.style.margin = "5px", h.style.width = "60%", h.style.border = "1px solid #aeaeae", i.appendChild(h);
  ...
  this._resetMovableNodes(), Array.isArray(t) || (t = []), Array.isArray(i) || (i = []);
  var a = {
    id: e,
    expandIds: t,
    collapseIds: i,
  ...
  if (FamilyTree.RESET_MOVABLE_ONEXPANDCOLLAPSE && null != this.config.movable) {
    for (var e = !1, t = 0; t < this.config.nodes.length; t++) {
      var i = this.config.nodes[t];
      null != i.movex && (i.movex = 0, e = !0), null != i.movey && (i.movey = 0, e = !0)
    }
  ...
  if (n.draggable) {
    ...
    var T = function (e, t) {
      ...
      b = function (t) {
        if (p) {
          ...
          if (s.left || s.right || s.up || s.down) {
            h.classList && (h.classList.remove("bft-cursor-grab"), h.classList.add("bft-cursor-move"), h.classList.remove("bft-cursor-nodrop"), h.classList.remove("bft-cursor-copy"));
            var b = u[4],
              x = u[5],
              _ = p.x,
              w = p.y,
            ...
            o.moveStart(s, (function (e) {
              u[4] = b + e.x, u[5] = x + e.y, p.x = _ - e.xWithoutScale, p.y = w - e.yWithoutScale, i.x = k - e.xWithoutScale, i.y = S - e.yWithoutScale, f.setAttribute("transform", "matrix(" + u.toString() + ")")
            }))
          } else {
            for (o.moveEnd(), h.classList && (h.classList.add("bft-cursor-grab"), h.classList.remove("bft-cursor-move"), h.classList.remove("bft-cursor-nodrop"), h.classList.remove("bft-cursor-copy")), T(c, m), c = null, m = null; null != r && r != h;) {
            ...
            if (null != c) {
              ...
              h.classList.remove("bft-cursor-grab"), h.classList.remove("bft-cursor-move"), h.classList.add("bft-cursor-copy"), h.classList.remove("bft-cursor-nodrop")
            }
            var E = (i.x - p.x) / d,
              M = (i.y - p.y) / d;
            if (u[4] = y + E, u[5] = g + M, !e._dragEventFired && (Math.abs(i.x - p.x) > FamilyTree.FIRE_DRAG_NOT_CLICK_IF_MOVE || Math.abs(i.y - p.y) > FamilyTree.FIRE_DRAG_NOT_CLICK_IF_MOVE)) !1 === FamilyTree.events.publish("drag", [o.nodeCircleMenuUI, {
              from: C,
              menuItem: n,
              menuItemName: a
      ...
      F = function (t) {
        if (o.moveEnd(), h.classList && (h.classList.remove("bft-cursor-grab"), h.classList.remove("bft-cursor-move"), h.classList.remove("bft-cursor-nodrop"), h.classList.remove("bft-cursor-copy")), h.removeEventListener(i.move, b), h.removeEventListener(i.up, F), i.leave && h.removeEventListener(i.leave, F), s.id == c || null == c) return h.removeChild(f), o._gragStartedId = null, void (e._dragEventFired && FamilyTree.events.publish("drop", [o.nodeCircleMenuUI, {
          from: s.id,
          menuItemName: a,
          menuItem: n,
          event: t
        ...
        FamilyTree.events.publish("drop", [o.nodeCircleMenuUI, {
          ...
          menuItemName: a,
          event: t
        }]), T(c, m), h.removeChild(f), o._gragStartedId = null
      };
    h.addEventListener(i.move, b), h.addEventListener(i.up, F), i.leave && h.addEventListener(i.leave, F)
  }
}, FamilyTree.prototype._nodeMouseDownHandler = function (e, t, i) {
  var r = e.getAttribute(FamilyTree.attr.node_id),
    a = this.getNode(r);
  this.config.movable && !FamilyTree.getRootOf(a).stParent ? this._movableHandler(e, t, i) : this.config.enableDragDrop && this._dragDropHandler(e, t, i)
  ...
  var r = this,
    ...
    l = function (e, t) {
      if (Array.isArray(e))
        ...
        t.push(e.id);
        for (i = 0; i < e.stChildrenIds.length; i++) l(r.getNode(e.stChildrenIds[i]), t);
        for (i = 0; i < e.childrenIds.length; i++) l(r.getNode(e.childrenIds[i]), t)
      }
    },
    s = this.getNode(a);
  o(s, n);
  for (var d = this.getSvg(), c = FamilyTree._getClientXY(t), m = [], h = [], p = [], f = [], u = [], y = [], g = [], v = [], T = 0; T < n.length; T++) {
  ...
  var C = {
    ...
    N = function (e, t) {
      if (null != e) {
        t.classList.remove("bft-drag-over");
        for (var i = r.getNode(k), a = FamilyTree.getStParentNodes(i), n = 0; n < a.length; n++) {
    ...
    A = function (t) {
      if (C) {
        ...
        if (c.left || c.right || c.up || c.down) {
          ...
          for (var T = [], b = [], F = [], x = [], _ = 0; _ < h.length; _++) T.push(h[_][4]), b.push(h[_][5]), g[_] ? (F.push(g[_][4]), x.push(g[_][5])) : (F.push(null), x.push(null));
          var w = C.x,
            A = C.y,
            E = i.x,
            M = i.y;
          r.moveStart(c, (function (e) {
            for (var t = 0; t < h.length; t++) {
              var a = T[t],
                ...
                o = F[t],
                l = x[t];
              h[t][4] = a + e.x, h[t][5] = n + e.y, C.x = w - e.xWithoutScale, C.y = A - e.yWithoutScale, i.x = E - e.xWithoutScale, i.y = M - e.yWithoutScale, m[t].x = a + e.x, m[t].y = n + e.y, m[t].movex = e.x, m[t].movey = e.y, g[t] && (g[t][4] = o + e.x, g[t][5] = l + e.y);
              for (var s = FamilyTree.ui.link(m[t], r, I, r.response.bordersByRootIdAndLevel, r.nodes, FamilyTree.action.update, !0), d = 0; d < s.length; d++) {
                var c = s[d];
                (p = r.element.querySelector(`[data-l-id="[${c.id}][${c.childId}]"]`)) && (p.innerHTML = c.html)
              }
              if (m[t].parent)
                for (s = FamilyTree.ui.link(m[t].parent, r, I, r.response.bordersByRootIdAndLevel, r.nodes, FamilyTree.action.update, !0), d = 0; d < s.length; d++) {
                  var p;
                  c = s[d];
                  (p = r.element.querySelector(`[data-l-id="[${c.id}][${c.childId}]"]`)) && (p.innerHTML = c.html)
                }
              u[t].setAttribute("transform", "matrix(" + h[t].toString() + ")"), y[t] && y[t].setAttribute("transform", "matrix(" + g[t].toString() + ")")
            }
          }))
        } else {
          if (r.moveEnd(), d.classList && (d.classList.add("bft-cursor-grab"), d.classList.remove("bft-cursor-move"), d.classList.remove("bft-cursor-nodrop"), d.classList.remove("bft-cursor-copy")), N(k, S), k = null, S = null, r.config.enableDragDrop)
            for (; null != o && o != d;) {
          ...
          if (null != k) {
            ...
            for (var U = r.getNode(k), B = FamilyTree.getStParentNodes(U), R = 0; R < B.length; R++) {
              var P = r.getNodeElement(B[R].id);
              P && (P.style.opacity = .1)
            } !r.canUpdateLink(m[0].id, k) && d.classList ? (d.classList.remove("bft-cursor-grab"), d.classList.remove("bft-cursor-move"), d.classList.remove("bft-cursor-copy"), d.classList.add("bft-cursor-nodrop")) : d.classList && (d.classList.remove("bft-cursor-grab"), d.classList.remove("bft-cursor-move"), d.classList.add("bft-cursor-copy"), d.classList.remove("bft-cursor-nodrop"))
          }
          var D = (i.x - C.x) / I,
            H = (i.y - C.y) / I;
          for (_ = 0; _ < h.length; _++) {
            h[_][4] = f[_].x + D, h[_][5] = f[_].y + H, g[_] && (g[_][4] = v[_].x + D, g[_][5] = v[_].y + H), m[_].x = p[_].x + D, m[_].y = p[_].y + H, m[_].movex = D, m[_].movey = H;
            var z = FamilyTree.ui.link(m[_], r, I, r.response.bordersByRootIdAndLevel, r.nodes, FamilyTree.action.update, !0);
            for (R = 0; R < z.length; R++) {
              var $ = z[R];
              (j = r.element.querySelector(`[data-l-id="[${$.id}][${$.childId}]"]`)) && (j.innerHTML = $.html)
            }
          }
          if (s.parent)
            if (r.config.movable == FamilyTree.movable.detachTree) (j = r.element.querySelector(`[data-l-id="[${s.parent.id}][${s.id}]"]`)) && j.parentElement.removeChild(j);
            else
              for (z = FamilyTree.ui.link(s.parent, r, I, r.response.bordersByRootIdAndLevel, r.nodes, FamilyTree.action.update, !0), R = 0; R < z.length; R++) {
                var j;
                $ = z[R];
                (j = r.element.querySelector(`[data-l-id="[${$.id}][${$.childId}]"]`)) && (j.innerHTML = $.html)
              }
          if (!e._dragEventFired && (Math.abs(i.x - C.x) > FamilyTree.FIRE_DRAG_NOT_CLICK_IF_MOVE || Math.abs(i.y - C.y) > FamilyTree.FIRE_DRAG_NOT_CLICK_IF_MOVE)) {
            if (!1 === FamilyTree.events.publish("drag", [r, a, t, n]) && L(), r.config.enableDragDrop)
              for (_ = 0; _ < u.length; _++) d.insertBefore(u[_], d.firstChild);
            e._dragEventFired = !0
          }
          for (_ = 0; _ < h.length; _++) u[_].setAttribute("transform", "matrix(" + h[_].toString() + ")"), y[_] && y[_].setAttribute("transform", "matrix(" + g[_].toString() + ")")
        }
      }
    },
    L = function (t) {
      for (var a = 0; a < m.length; a++) m[a].x = p[a].x, m[a].y = p[a].y;
      if (r.moveEnd(), d.classList && (d.classList.remove("bft-cursor-grab"), d.classList.remove("bft-cursor-move"), d.classList.remove("bft-cursor-nodrop"), d.classList.remove("bft-cursor-copy")), d.removeEventListener(i.move, A), d.removeEventListener(i.up, L), i.leave && d.removeEventListener(i.leave, L), m[0].id != k && null != k) {
        var n = r.getNode(k);
        if (!1 === (o = FamilyTree.events.publish("drop", [r, m[0].id, n.id, u[0], t]))) return N(k, S), void (r._gragStartedId = null);
        if (r.canUpdateLink(m[0].id, k)) (g = r.get(m[0].id)).pid = k, g.stpid = null, r.updateNode(g, null, !0);
        else N(k, S);
        r._gragStartedId = null
      } else {
        if (e._dragEventFired) {
          var o = FamilyTree.events.publish("drop", [r, m[0].id, void 0, u[0], t]);
          if (r.config.movable && !1 !== o)
            if (r.config.movable == FamilyTree.movable.detachTree) {
              ...
              (g = r.get(s.id)).pid = null, g.stpid = null, r.updateNode(g, null, !0)
            } else {
              var h = [];
              r.config.movable == FamilyTree.movable.node ? h.push(s.id) : l(s, h);
              var f = (c = FamilyTree._getTransform(r.getNodeElement(s.id)))[4] - s.x,
                y = c[5] - s.y;
              for (a = 0; a < h.length; a++) {
                var g;
                (g = r.get(h[a])) && (null != g.movex ? g.movex += f : g.movex = f, null != g.movey ? g.movey += y : g.movey = y, r.update(g))
              }
              FamilyTree.events.publish("updated", [r]), r.draw(FamilyTree.action.update, {
                dragNodeIdList: h
              })
            }
        }
  ...
  d.addEventListener(i.move, A), d.addEventListener(i.up, L), i.leave && d.addEventListener(i.leave, L)
    ...
    g = function (t) {
      if (c) {
        ...
        if (g.left || g.right || g.up || g.down) {
          ...
          var A = (i.x - c.x) / f,
            L = (i.y - c.y) / f;
          if (m[4] = h + A, m[5] = p + L, !e._dragEventFired && (Math.abs(i.x - c.x) > FamilyTree.FIRE_DRAG_NOT_CLICK_IF_MOVE || Math.abs(i.y - c.y) > FamilyTree.FIRE_DRAG_NOT_CLICK_IF_MOVE)) !1 === FamilyTree.events.publish("drag", [s, k, t]) && v(), e._dragEventFired = !0;
  ...
  if (null == this.instance.config.searchFields) {
    ...
    for (var e = 0; e < this.instance.response.allFields.length; e++) {
      ...
      "tags" == t || FamilyTree._fieldIsImg(this.instance.config, t) || -1 == this._searchFields.indexOf(t) && this._searchFields.push(t)
    }
  ...
  FamilyTree.state._get(this.config.state, t, i, (function (d) {
    ...
    var c = s.maxX,
      ...
      y = s.nodes;
    if (e) {
      var g = FamilyTree.manager._getResponse(t, i, s.visibleNodeIds, s.config, c, m, h, p, s.viewBox, u, s.action, s.actionParams, y, s.oldNodes, s.vbIsInitializedFromState);
      a != FamilyTree.action.exporting && (s.maxX = c, s.maxY = m, s.minX = h, s.minY = p, s.roots = u, s.nodes = y, s.visibleNodeIds = g.visibleNodeIds), g.bordersByRootIdAndLevel = f, g.roots = u, g.adjustify = {
        x: 0,
        y: 0
      }, s.state && (g.adjustify = s.state.adjustify), o(g)
    } else s.oldNodes = y || null, s._read((function (e) {
      c = e.maxX, m = e.maxY, h = e.minX, p = e.minY, f = e.bordersByRootIdAndLevel, u = e.roots, y = e.nodes;
      var r = FamilyTree.manager._getResponse(t, i, s.visibleNodeIds, s.config, c, m, h, p, s.viewBox, u, s.action, s.actionParams, y, s.oldNodes, s.vbIsInitializedFromState);
      r.notif = e.limit, r.roots = u, r.bordersByRootIdAndLevel = f, r.adjustify = e.adjustify, a != FamilyTree.action.exporting && (s.maxX = c, s.maxY = m, s.minX = h, s.minY = p, s.roots = u, s.nodes = y, s.visibleNodeIds = r.visibleNodeIds, s.bordersByRootIdAndLevel = f, s.rootList = e.rootList), o(r)
    }), l)
  }))
  ...
  null == o && (o = FamilyTree.local), o._setPositions(n, i.layoutConfigs, (function (t) {
    ...
    for (var l = {
      ...
      maxX: null,
      maxY: null
    }, s = {}, d = [], c = 0; c < n.length; c++) FamilyTree.manager._setMinMaxXYAdjustifyIterate(n[c], n[c], l, 0, s, o, i.config.orientation, d);
    for (var m in d)
      for (var h in d[m]) {
        var p = s[m][h],
          f = d[m][h];
        null == p.minX && null == p.minY && null == p.maxX && null == p.maxY && FamilyTree._setMinMaxXY(f, p)
      }
    e({
      minX: l.minX,
      minY: l.minY,
  ...
  var l = o.manager.config,
    ...
    m = o.manager.state,
    h = s[i || "base"];
  null == e.parent && FamilyTree.manager._setCollpasedProperty(e, h, c, a, d, r - 1, m);
  for (var p = 0; p < e.childrenIds.length; p++) {
    var f = t[e.childrenIds[p]];
    if (FamilyTree.manager._setCollpasedProperty(f, h, c, a, d, r, m), !f.collapsed) {
  ...
  if (FamilyTree.manager._initNode(t, i, s, r, d, c, m), t.isAssistant && (n[t.pid] || (n[t.pid] = []), n[t.pid].push(t.id)), t.subLevels > 0 && o.push(t.id), FamilyTree.MIXED_LAYOUT_FOR_NODES_WITH_COLLAPSED_CHILDREN && !t.isAssistant && t.parent) {
    if (t.parent && t.parent.children.length && t.parent.children[t.parent.children.length - 1] == t) {
      for (var p = [], f = 0, u = 0, y = 0; y < t.parent.children.length; y++) {
        -1 == (g = t.parent.children[y]).tags.indexOf("partner") && -1 == g.tags.indexOf("left-partner") && -1 == g.tags.indexOf("right-partner") && -1 == g.tags.indexOf("assistant") && 0 == g.children.length ? p.push(g.id) : -1 != g.tags.indexOf("assistant") ? f++ : -1 == g.tags.indexOf("partner") && -1 == g.tags.indexOf("left-partner") && -1 == g.tags.indexOf("right-partner") || u++
      } (FamilyTree.MIXED_LAYOUT_ALL_NODES && p.length > 1 && p.length == t.parent.children.length - f - u || !FamilyTree.MIXED_LAYOUT_ALL_NODES && p.length > 1) && (l[t.pid] = p)
    }
  } else if (!t.isAssistant && 0 == t.childrenIds.length && t.parent && !l[t.pid]) {
    for (p = [], f = 0, u = 0, y = 0; y < t.parent.children.length; y++) {
      var g; - 1 == (g = t.parent.children[y]).tags.indexOf("partner") && -1 == g.tags.indexOf("left-partner") && -1 == g.tags.indexOf("right-partner") && -1 == g.tags.indexOf("assistant") && 0 == g.childrenIds.length ? p.push(g.id) : -1 != g.tags.indexOf("assistant") ? f++ : -1 == g.tags.indexOf("partner") && -1 == g.tags.indexOf("left-partner") && -1 == g.tags.indexOf("right-partner") || u++
    } (FamilyTree.MIXED_LAYOUT_ALL_NODES && p.length > FamilyTree.MIXED_LAYOUT_IF_NUMBER_OF_CHILDREN_IS_MORE_THEN && p.length == t.parent.childrenIds.length - f - u || !FamilyTree.MIXED_LAYOUT_ALL_NODES && p.length > FamilyTree.MIXED_LAYOUT_IF_NUMBER_OF_CHILDREN_IS_MORE_THEN) && (l[t.pid] = p)
  }
  ...
  for (var s = [], d = FamilyTree._addDottedLines(i), c = 0; c < d.length; c++) {
    var m, h = d[c];
    m = FamilyTree.STRING_TAGS ? h.tags ? h.tags.split(",") : [] : Array.isArray(h.tags) ? h.tags.slice(0) : [], l.filterUI.addFilterTag(h) && m.unshift("filter");
    ...
    FamilyTree.isNEU(h.ppid) || (u.ppid = h.ppid), FamilyTree.isNEU(h.stpid) || (u.stpid = h.stpid), null != i.orderBy && (u.order = FamilyTree.manager._getOrderFieldValue(h, i.orderBy)), null != h.movex && (u.movex = h.movex), null != h.movey && (u.movey = h.movey), e[h.id] = u, s.push(h.id)
  }
  ...
  if (FamilyTree.manager.__createNodes(l, s, t, r, a, n, d, e), null != t.roots) {
    ...
    for (var c = 0; c < t.roots.length; c++) {
      ...
      if (m && r == FamilyTree.action.centerNode) {
        for (var h = m; null != h.pid || null != h.stpid;) h = null == h.pid && null != h.stpid ? l[h.stpid] : l[h.pid];
        for (var p = l[a.id];
          (null != p.pid || null != p.stpid) && p != m;) p = null == p.pid && null != p.stpid ? l[p.stpid] : l[p.pid];
        h == p && (m = h)
      }
      if (m) {
  ...
  for (c = 0; c < S.length; c++) {
    ...
    for (b = N.length - 1; b >= 0; b--)
      if (A[N[b]])
        for (u = 0; u < A[N[b]].length; u++) g.children.push(l[A[N[b]][u]]), E++, -1 == U.indexOf(N[b]) && U.push(N[b]);
    ...
    for (b = 0; b < I.length; b++)
      if (A[I[b]])
        for (u = 0; u < A[I[b]].length; u++) g.children.push(l[A[I[b]][u]]), M++, -1 == O.indexOf(I[b]) && O.push(I[b]);
    for (b = 0; b < B.length; b++) {
      (D = l[B[b]]).collapsed || (D.parentPartner = D.parent, D.parent = g, D.isChildOfPartner = !0, g.children.push(D))
    }
    g.partnerSeparation = Math.max(U.length, O.length) * t.partnerChildrenSplitSeparation + t.minPartnerSeparation, C.length || !E || M ? C.length || E || !M ? C.length || 1 != E || 1 != M ? C.length || E || M ? !C.length || E || M ? C.length && (E || M) ? g.hasPartners = 7 : g.hasPartners = 1 : g.hasPartners = 6 : g.hasPartners = 5 : g.hasPartners = 4 : g.hasPartners = 3 : g.hasPartners = 2
  }
  ...
  for (var $ in _) {
    ...
    if (j.length % 2) {
      ...
      FamilyTree.manager._initDinamicNode(X, Y.lcn, !0), X.isAssistant = !0, X.w = Y.w, X.h = Y.h, l[X.id] = X, j.splice(j.length - 1, 0, X.id)
    }
    var q = 1;
    for (b = j.length - 1; b >= 0; b--)
      if (b % 2 && b != j.length - 1) {
        var V = new FamilyTree.node(v.id + "_split_assitant_" + q, v.pid, [], "split");
        FamilyTree.manager._initDinamicNode(V, v.lcn, !0), l[V.id] = V, j.splice(b, 0, V.id), q++
  ...
  if (Z || ee) {
    ...
    for (var $ in k) {
      ...
      if (0 != (H = i[v.lcn ? v.lcn : "base"]).layout || ee) {
        te.pnode = v, te.layout = H.layout, te.layoutGridColumns = t.layoutGridColumns, te.childrenIds = k[$], te.lastChildrenPidIds = k, te.subLevels = 0, te.layouts = [], FamilyTree.events.publish("node-layout", [e, te]), FamilyTree.events.publish("layout", [te]), te.layouts.length || te.layouts.push({
          layout: te.layout,
        ...
        for (var he = 0; he < te.layouts.length; he++) {
          ...
          for (FamilyTree.isNEU(pe.subLevels) && (pe.subLevels = 0), FamilyTree.isNEU(pe.layout) && (pe.layout = H.layout), me = v = l[$]; me.isSplit;) me = l[me.pid];
          for (; me.isSubLevel;) me = l[me.pid];
          var fe = v;
          for (b = 0; b < pe.subLevels; b++) {
            z = new FamilyTree.node(he + "_sublevel_layout_" + b, fe.id, [], "subLevel");
          ...
          if (pe.subLevels) {
            for (b = 0; b < pe.childrenIds.length; b++) {
              var ue;
              D = l[pe.childrenIds[b]]; - 1 != (ue = v.children.indexOf(D)) && v.children.splice(ue, 1), D.parent = fe, fe.children.push(D)
            }
            v = fe
          }
          if (pe.layout == FamilyTree.layout.grid && pe.childrenIds.length > 2) {
            "dynamic" == pe.layoutGridColumns && (pe.layoutGridColumns = FamilyTree._getDynamicGridCoulumns(pe.childrenIds.length));
            var ye = v.id;
            ...
            for (c = 0; c < pe.childrenIds.length; c += ge) {
              ...
              for (b = 0; b < ge; b++) {
                ...
                (D = l[de = pe.childrenIds[c + b]]).parent = l[ye], l[ye].children.push(D), Te || (ge / 2 - 1 == b && (ve = new FamilyTree.node(pe.childrenIds[c + b - 1] + "_grid_pseudo_node_" + pe.childrenIds[c + b + 1], ye, [], "subLevel"), FamilyTree.manager._initDinamicNode(ve, v.lcn), ve.parent = l[ye], l[ye].children.push(ve), l[ve.id] = ve), ge - 1 == b && (ye = ve.id))
              }
            }
          }
          if (pe.layout == FamilyTree.layout.mixed) {
            ...
            for (c = be.length - 1; c >= 0; c--) {
              v = (D = l[be[c]]).parent, D.layout = FamilyTree.layout.mixed;
              for (b = v.children.length - 1; b >= 0; b--)
                if (D.id == v.children[b].id) {
                  ...
                  var Fe = l[be[c - 1]];
                  D.parent = Fe, D.layout = FamilyTree.layout.mixed, Fe.children.push(D)
                } else v.children.push(D)
            }
          } else if (pe.layout > 1) {
            z = new FamilyTree.node(he + "_" + v.id + "_split_0", me.id, [], "split");
            FamilyTree.manager._initDinamicNode(z, v.lcn), l[z.id] = z, z.layout = pe.layout;
            var xe = [];
            for (c = pe.childrenIds.length - 1; c >= 0; c--) {
              for (D = l[pe.childrenIds[c]], b = 0; b < v.children.length; b++) v.children[b].id == D.id && v.children.splice(b, 1);
              if (D.parent = null, D.layout = pe.layout, pe.layout != FamilyTree.layout.treeRightOffset && pe.layout != FamilyTree.layout.treeRight || xe.splice(0, 0, D.id), pe.layout > 2) {
                var _e = new FamilyTree.node(he + "_" + D.id + "_mirror", me.id, [], "mirror");
                FamilyTree.manager._initDinamicNode(_e, D.lcn), _e.layout = pe.layout, l[_e.id] = _e, xe.splice(0, 0, _e.id)
              }
              pe.layout != FamilyTree.layout.treeRightOffset && pe.layout != FamilyTree.layout.treeRight && xe.splice(0, 0, D.id)
            }
            for (q = 1, b = xe.length - 1; b >= 0; b--)
              if (b % 2 && b != xe.length - 1) {
                V = new FamilyTree.node(he + "_" + v.id + "_split_" + q, me.id, [], "split");
                FamilyTree.manager._initDinamicNode(V, v.lcn), V.layout = pe.layout, l[V.id] = V, xe.splice(b, 0, V.id), q++
              } else b % 2 && xe.splice(b, 0, z.id);
            for (b = 0; b < xe.length; b += 3) {
              G = null;
              0 == b && (G = v);
              W = l[xe[b]], J = l[xe[b + 1]], K = l[xe[b + 2]];
              0 != b && (G = l[xe[b - 3]]), 0 == b || J || (G = l[xe[b - 2]]), W.parent = G, G.children.push(W), J && (0 != b && (G = l[xe[b - 2]]), J.parent = G, G.children.push(J)), K && (0 != b && (G = l[xe[b - 1]]), K.parent = G, G.children.push(K))
            }
          }
        }
      }
...
}, FamilyTree.manager._getResponse = function (e, t, i, r, a, n, o, l, s, d, c, m, h, p, f) {
  var u = d[0],
    y = [],
    g = {
      top: null,
  ...
  if (c == FamilyTree.action.insert || c == FamilyTree.action.expand || c == FamilyTree.action.collapse || c == FamilyTree.action.update || c == FamilyTree.action.centerNode) {
    var C = null;
    if (c == FamilyTree.action.insert && m && null != m.insertedNodeId && null != m.insertedNodeId) C = h[m.insertedNodeId];
    else if (c == FamilyTree.action.update && m && null != m.visId && null != m.visId) C = h[m.visId];
    else if (c != FamilyTree.action.expand && c != FamilyTree.action.collapse || !m || null == m.id || null == m.id) {
  ...
  for (var N = 0; N < d.length; N++) FamilyTree.manager._iterate2(d[N], h, r, s, c, m, y, p, i, v);
  return {
    animations: v,
    boundary: g,
    viewBox: s,
  ...
  if (FamilyTree.manager._isVisible(e, i, r, a)) {
    ...
    if ((a == FamilyTree.action.expand || a == FamilyTree.action.collapse || a == FamilyTree.action.maximize) && l && l[e.id] && "expandCollapseToLevel" == n.method) {
      if (c = {
        ...
        for (var m = e, h = null; null != m;) l[m.id] && l[m.id].collapsed && (h = m), m = m.parent;
        h && h.parent && (c = {
          x: h.parent.x,
          y: h.parent.y
        })
      ...
      if (c = {
        ...
        for (m = e, h = null; null != m;) l[m.id] && l[m.id].collapsed && (h = m), m = m.parent;
        h && h.parent && (c = {
          x: h.parent.x,
          y: h.parent.y
        })
      ...
      if (null != (f = l[e.id]).x && null != f.y && (c = {
        x: f.x,
        y: f.y
      }), (p = t[n.id]) && p == e) (m = e.parent) && m.id == n.id && (c = {
        x: p.x + p.w / 2 - e.w / 2,
        y: p.y + p.h / 2 - e.h / 2
      })
...
}, FamilyTree.manager._setMinMaxXYAdjustifyIterate = function (e, t, i, r, a, n, o, l) {
  e.x += n.x, e.y += n.y;
  for (var s = 0; s < e.stChildren.length; s++) FamilyTree.manager._setMinMaxXYAdjustifyIterate(e.stChildren[s], e.stChildren[s], i, 0, a, n, o, l);
  e.isPartner ? e.sl = r - 1 : e.sl = r, null == a[t.id] && (a[t.id] = {}), null == a[t.id][e.sl] && (a[t.id][e.sl] = {
    minX: null,
    minY: null,
    maxX: null,
    maxY: null
  }), e.layout ? (null == l[t.id] && (l[t.id] = {}), null == l[t.id][e.sl] && (l[t.id][e.sl] = e)) : FamilyTree._setMinMaxXY(e, a[t.id][e.sl]), null != e.movex && (e.x += e.movex), null != e.movey && (e.y += e.movey), FamilyTree._setMinMaxXY(e, i), r++;
  for (s = 0; s < e.children.length; s++) FamilyTree.manager._setMinMaxXYAdjustifyIterate(e.children[s], t, i, r, a, n, o, l)
  ...
  if (e.isAssistant && e.isSplit && e.children.length) {
    ...
    if (d.length) {
      for (var m = d[d.length - 1], h = d[0], p = e.children.length - 1; p >= 0; p--) {
        var f = e.children[p];
  ...
  for (var s = i.nodes, d = [], c = {}, m = {}, h = 0; h < s.length; h++) {
    var p, f = s[h];
    p = FamilyTree.STRING_TAGS ? f.tags ? f.tags.split(",") : [] : Array.isArray(f.tags) ? f.tags.slice(0) : [], l.filterUI.addFilterTag(f) && p.push("filter");
    var u = l.searchUI.addMatchTag(f.id);
    !0 === u ? p.unshift("match") : !1 === u && p.unshift("no-match"), f.gender && p.push(f.gender);
  ...
  for (h = 0; h < i.roots.length; h++) FamilyTree.manager._iterateFT(i.roots[h], m, c, e, n, t, r, a, i)
  ...
  var d, c = r[e],
    ...
    p = r[c.mid],
    f = r[c.fid];
  if (h || (c.stpid = null), p ? f && (p.tags.has("partner") || p.tags.has("left-partner") || p.tags.has("right-partner")) ? (c.pid = f.id, d = f, c.ppid = p.id) : (c.pid = p.id, d = p, f && (c.ppid = f.id)) : f ? p && (f.tags.has("partner") || f.tags.has("left-partner") || f.tags.has("right-partner")) ? (c.pid = p.id, d = p, c.ppid = f.id) : (c.pid = f.id, d = f, p && (c.ppid = p.id)) : c.pid, h) {
    var u = a ? a[h.id] : null;
    u && (h.min = u.min), h.stChildrenIds.push(c.id)
  } else p || f ? (m && (c.collapsed = m.collapsed, c.min = m.min), d && !d.childrenIds.has(c.id) && d.childrenIds.push(c.id), p && !p.ftChildrenIds.has(c.id) && p.ftChildrenIds.push(c.id), f && !f.ftChildrenIds.has(c.id) && f.ftChildrenIds.push(c.id)) : (m && (c.collapsed = m.collapsed, c.min = m.min), n.push(c));
  ...
  node: function (e, t, i, r, a, n, o, l, s, d) {
    ...
    for (var p in o) {
      ...
      if (h.value = f, h.element = c[p], h.name = u, h.field = p, !1 !== FamilyTree.events.publish("field", [d, h]) && null != h.value && null != h.value && null != h.element && (!y || y && !FamilyTree.isNEU(h.value))) {
        if (!y && "string" == typeof h.value) {
          var g = h.element;
          g && (g = g.replaceAll("{ew}", e.w - (e.padding ? e.padding[1] : 0)).replaceAll("{cw}", e.w / 2)), h.value = FamilyTree.wrapText(h.value, g)
        }
  ...
  link: function (e, t, i, r, a, n, o) {
    ...
    if (e.hasPartners) {
      ...
      y.maxSidePartnersWithChildren = Math.max(y.leftIds.length, y.rightIds.length), p = 0 == y.maxSidePartnersWithChildren ? t.config.minPartnerSeparation / 2 : t.config.minPartnerSeparation / 2 + y.partnerChildrenSplitSeparation * y.maxSidePartnersWithChildren + y.partnerChildrenSplitSeparation / 2
    }
    for (g = 0; g < e.children.length; g++) {
      ...
      if (T.isChildOfPartner) switch (s.orientation) {
        ...
        if ((w || T.layout > 1) && T.rightNeighbor && T.rightNeighbor.isSplit) switch (s.orientation) {
          ...
          case FamilyTree.orientation.top:
          case FamilyTree.orientation.top_left:
            if (1 == T.isPartner) F = FamilyTree.ui._linkLeftToRight(e, T, d, p);
            else if (2 == T.isPartner) F = FamilyTree.ui._linkRightToLeft(e, T, d, p);
            else {
          ...
          case FamilyTree.orientation.right:
          case FamilyTree.orientation.right_top:
            if (1 == T.isPartner) F = FamilyTree.ui._linkTopToBottom(e, T, d, p);
            else if (2 == T.isPartner) F = FamilyTree.ui._linkBottomToTop(e, T, d, p);
            else {
              _ = 1 == T.layout ? void 0 : b.maxX - (b.maxX - u.minX) / 2;
      ...
      if (S) v = S, x = x.replaceAll("{rounded}", S).replaceAll("{edge}", S).replaceAll("{curve}", v);
      else if (-1 != x.indexOf("{rounded}"))
        if (F.xa == F.xb && F.xa == F.xc && F.xa == F.xd || F.ya == F.yb && F.ya == F.yc && F.ya == F.yd) v = "M" + F.xa + "," + F.ya + " L" + F.xd + "," + F.yd, x = x.replaceAll("{rounded}", v);
        else if (Math.abs(F.xa - F.xd) <= FamilyTree.LINK_ROUNDED_CORNERS && Math.abs(F.xa - F.xc) <= FamilyTree.LINK_ROUNDED_CORNERS && Math.abs(F.xa - F.xb) <= FamilyTree.LINK_ROUNDED_CORNERS) v = "M" + F.xa + "," + F.ya + " L" + F.xa + "," + F.yd, x = x.replaceAll("{rounded}", v);
        else if (Math.abs(F.ya - F.yd) <= FamilyTree.LINK_ROUNDED_CORNERS && Math.abs(F.ya - F.yc) <= FamilyTree.LINK_ROUNDED_CORNERS && Math.abs(F.ya - F.yb) <= FamilyTree.LINK_ROUNDED_CORNERS) v = "M" + F.xa + "," + F.ya + " L" + F.xd + "," + F.ya, x = x.replaceAll("{rounded}", v);
        else {
          var C = FamilyTree.ui._roundedEdge(F.xa, F.ya, F.xb, F.yb, F.xc, F.yc),
            I = FamilyTree.ui._roundedEdge(F.xb, F.yb, F.xc, F.yc, F.xd, F.yd);
          v = "M" + C.x1 + "," + C.y1 + " " + C.x2 + "," + C.y2 + " Q" + C.qx1 + "," + C.qy1 + " " + C.qx2 + "," + C.qy2 + " L" + I.x2 + "," + I.y2 + " Q" + I.qx1 + "," + I.qy1 + " " + I.qx2 + "," + I.qy2 + " L" + I.x3 + "," + I.y3, x = x.replaceAll("{rounded}", v)
        } else -1 != x.indexOf("{edge}") ? (v = "M" + F.xa + "," + F.ya + " " + F.xb + "," + F.yb + " " + F.xc + "," + F.yc + " L" + F.xd + "," + F.yd, x = x.replaceAll("{edge}", v)) : -1 != x.indexOf("{curve}") ? (v = "M" + F.xa + "," + F.ya + " C" + F.xb + "," + F.yb + " " + F.xc + "," + F.yc + " " + F.xd + "," + F.yd, x = x.replaceAll("{curve}", v)) : (v = x.replaceAll("{xa}", F.xa).replaceAll("{ya}", F.ya).replaceAll("{xb}", F.xb).replaceAll("{yb}", F.yb).replaceAll("{xc}", F.xc).replaceAll("{yc}", F.yc).replaceAll("{xd}", F.xd).replaceAll("{yd}", F.yd), x = v);
      c.push(FamilyTree.linkOpenTag.replaceAll("{id}", e.id).replaceAll("{class}", "link " + T.tags.join(" ")).replaceAll("{child-id}", T.id));
      var N = {
        node: e,
        cnode: T,
        p: F,
      ...
      for (var L in t.config.linkBinding) {
        ...
        if (M) {
          var O = M[E];
          N.value = O, N.element = d[L], N.name = E, !1 !== FamilyTree.events.publish("label", [t, N]) && (FamilyTree.isNEU(N.value) || FamilyTree.isNEU(N.element) || (A += N.element.replace("{val}", N.value)))
        }
      }
      if ("" != A) {
        var U = F.x,
          B = F.y;
        null != T.movey && (B += T.movey), A = FamilyTree.linkFieldsOpenTag.replace("{x}", U).replace("{y}", B).replace("{rotate}", 0) + A + FamilyTree.grCloseTag, c.push(A)
      }
  ...
  l.value = t.format, s.value = t.landscape, d.value = t.scale, c.value = t.margin, m.value = t.header, h.value = t.footer, FamilyTree.animate(e.element.querySelector("#bft-ppdf-btns"), {
    margin: [0, 0, 0, -250]
  }, {
    margin: [0, 0, 0, 0]
  }, 300, FamilyTree.anim.outSin, (function () {
    ...
    clearTimeout(o), o = setTimeout((function () {
      FamilyTree.animate(e.element.querySelector("#bft-ppdf-content"), {
        ...
        e.element.querySelector("#bft-ppdf-content").innerHTML = "", t.footer = h.value, e.exportPDF(t, FamilyTree.pdfPrevUI._handler)
      }))
    }), 1e3)
  }))
  ...
  for (var s = l.querySelector("svg"), d = e.element.querySelector("#bft-ppdf-content"), c = 0; c < a.length; c++) {
    ...
    h.open(), m.style.width = a[c].size.w + "px", m.style.height = a[c].size.h + "px", m.style.margin = "10 auto", a[c].backgroundColor && (m.style.backgroundColor = a[c].backgroundColor);
    var p = r.header;
    a[c].header && (p = a[c].header), p && (p = p.replace("{current-page}", c + 1).replace("{total-pages}", a.length));
    var f = r.footer;
    a[c].footer && (f = a[c].footer), f && (f = f.replace("{current-page}", c + 1).replace("{total-pages}", a.length)), a[c].html ? h.write(FamilyTree._exportHtml(a[c].html, t.styles, r, a[c].innerSize.w, a[c].innerSize.h, p, f, e.config.mode)) : (s.setAttribute("viewBox", a[c].vb), h.write(FamilyTree._exportHtml(l.innerHTML, t.styles, r, a[c].innerSize.w, a[c].innerSize.h, p, f, e.config.mode)));
  ...
  for (var i = "", r = 0; r < this.config.clinks.length; r++) {
    ...
    if (n && -1 != t.res.visibleNodeIds.indexOf(n.id) && (o && -1 != t.res.visibleNodeIds.indexOf(o.id))) {
      ...
      switch (this.config.orientation) {
        case FamilyTree.orientation.top:
        case FamilyTree.orientation.top_left:
          p <= f ? (g = 1, m.x = p + n.w / 10, h.x = f - o.w / 10) : (g = -1, m.x = p - n.w / 10, h.x = f + o.w / 10), s == c ? (g = 1, m.y = s, h.y = c) : s > c ? (m.y = s, h.y = c + o.h) : (m.y = s + n.h, h.y = c);
          break;
        case FamilyTree.orientation.bottom:
        case FamilyTree.orientation.bottom_left:
          p <= f ? (g = -1, m.x = p + n.w / 10, h.x = f + o.w / 10) : (g = 1, m.x = p - n.w / 10, h.x = f + o.w / 10), s == c ? (g = -1, m.y = s + n.h, h.y = c + o.h) : s > c ? (m.y = s, h.y = c + o.h) : (m.y = s + n.h, h.y = c);
          break;
        case FamilyTree.orientation.left:
        case FamilyTree.orientation.left_top:
          u <= y ? (g = -1, m.y = u + n.h / 5, h.y = y + o.h / 5) : (g = 1, m.y = u - n.h / 5, h.y = y + o.h / 5), l == d ? (g = -1, m.x = l, h.x = d) : l > d ? (m.x = l, h.x = d + o.w) : (m.x = l + n.w, h.x = d);
          break;
        case FamilyTree.orientation.right:
        case FamilyTree.orientation.right_top:
          u <= y ? (g = 1, m.y = u + n.h / 5, h.y = y + o.h / 5) : (g = -1, m.y = u - n.h / 5, h.y = y + o.h / 5), l == d ? (g = 1, m.x = l + n.w, h.x = d + o.w) : l > d ? (m.x = l, h.x = d + o.w) : (m.x = l + n.w, h.x = d)
      }
      var v = _(m, h, g),
        T = a.template;
      T || (T = "orange");
      ...
      var x = "M" + m.x + "," + m.y + "C" + m.x + "," + m.y + " " + v.x + "," + v.y + " " + h.x + "," + h.y;
  ...
  function n(t, n, o) {
    ...
    if (t.sl == n.sl) switch (d = n, h.orientation) {
      case FamilyTree.orientation.top:
      case FamilyTree.orientation.top_left:
        s.push([u.p, u.q]), s.push([u.p, u.q - f / 3]), p = FamilyTree.t(d.templateName, d.min, r), s.push([d.x + d.w / 2 + p.expandCollapseSize, s[s.length - 1][1]]), s.push([s[s.length - 1][0], d.y]);
        break;
      case FamilyTree.orientation.bottom:
      case FamilyTree.orientation.bottom_left:
        u.q = t.y + t.h, u.s = a.maxY - f, s.push([u.p, u.q]), s.push([u.r, t.y + t.h + f / 3]), p = FamilyTree.t(d.templateName, d.min, r), s.push([d.x + d.w / 2 + p.expandCollapseSize, s[s.length - 1][1]]), s.push([s[s.length - 1][0], d.y + d.h]);
        break;
      case FamilyTree.orientation.left:
      case FamilyTree.orientation.left_top:
        u.p = t.x, u.q = t.y + t.h / 2 + p.expandCollapseSize, u.r = a.minX - f, u.s = t.y + t.h / 2 + p.expandCollapseSize, s.push([u.p, u.q]), s.push([t.x - f / 3, u.q]), p = FamilyTree.t(d.templateName, d.min, r), s.push([s[s.length - 1][0], d.y + d.h / 2 + p.expandCollapseSize]), s.push([d.x, s[s.length - 1][1]]);
        break;
      case FamilyTree.orientation.right:
      case FamilyTree.orientation.right_top:
        u.p = t.x + t.w, u.q = t.y + t.h / 2 + p.expandCollapseSize, u.r = a.maxX + f, u.s = t.y + t.h / 2 + p.expandCollapseSize, s.push([u.p, u.q]), s.push([t.x + t.w + f / 3, u.q]), p = FamilyTree.t(d.templateName, d.min, r), s.push([s[s.length - 1][0], d.y + d.h / 2 + p.expandCollapseSize]), s.push([d.x + d.w, s[s.length - 1][1]])
    } else {
      switch (h.orientation) {
        case FamilyTree.orientation.top:
        case FamilyTree.orientation.top_left:
        ...
        case FamilyTree.orientation.left:
        case FamilyTree.orientation.left_top:
          u.p = t.x, u.q = t.y + t.h / 2 + p.expandCollapseSize, u.r = a.minX - f, u.s = t.y + t.h / 2 + p.expandCollapseSize, s.push([u.p, u.q]), s.push([t.x - f / 3, u.q]);
          break;
        case FamilyTree.orientation.right:
        case FamilyTree.orientation.right_top:
          u.p = t.x + t.w, u.q = t.y + t.h / 2 + p.expandCollapseSize, u.r = a.maxX + f, u.s = t.y + t.h / 2 + p.expandCollapseSize, s.push([u.p, u.q]), s.push([t.x + t.w + f / 3, u.q])
      }
      ...
      for (; null == d;) {
        var v = !1,
          ...
          b = T.leftNeighbor,
          F = T.rightNeighbor;
        if (T.id == n.id ? d = T : FamilyTree._intersects(T, u, h) && (u = FamilyTree._addPoint(T, s, h, u, c), v = !0), T.id != n.id) {
          for (; b;) {
            if (b.id == n.id) {
              d = b;
              break
            }
            FamilyTree._intersects(b, u, h) && (u = FamilyTree._addPoint(b, s, h, u, c), v = !0), b = b.leftNeighbor
          }
          for (; F;) {
            if (F.id == n.id) {
              d = F;
            ...
            FamilyTree._intersects(F, u, h) && (u = FamilyTree._addPoint(F, s, h, u, c), v = !0), F = F.rightNeighbor
          }
        }
        if (!v) {
          var x = s[s.length - 1][0],
            _ = 0;
          if (T.parent) {
            f = h.levelSeparation, T.parent.layout && (f = h.mixedHierarchyNodesSeparation);
      ...
      switch (p = FamilyTree.t(d.templateName, d.min, r), s.splice(s.length - 1, 1), h.orientation) {
        case FamilyTree.orientation.top:
        case FamilyTree.orientation.top_left:
          s.push([d.x + d.w / 2 + p.expandCollapseSize, s[s.length - 1][1]]), s.push([s[s.length - 1][0], d.y + d.h]);
          break;
        case FamilyTree.orientation.bottom:
        case FamilyTree.orientation.bottom_left:
          s.push([d.x + d.w / 2 + p.expandCollapseSize, s[s.length - 1][1]]), s.push([s[s.length - 1][0], d.y]);
          break;
        case FamilyTree.orientation.left:
        case FamilyTree.orientation.left_top:
          s.push([s[s.length - 1][0], d.y + d.h / 2 + p.expandCollapseSize]), s.push([d.x + d.w, s[s.length - 1][1]]);
          break;
        case FamilyTree.orientation.right:
        case FamilyTree.orientation.right_top:
          s.push([s[s.length - 1][0], d.y + d.h / 2 + p.expandCollapseSize]), s.push([d.x, s[s.length - 1][1]])
      }
    }
    var k = l.template;
    k || (k = "orange");
    ...
    if (l.label) {
      var E = p.label.replace("{x}", I.x).replace("{y}", I.y).replace("{val}", l.label),
      ...
      i += p.label.replace("{x}", I.x).replace("{y}", I.y + O).replace("{val}", l.label)
    }
    var U = t.id,
      B = n.id;
    o && (U = n.id, B = t.id), i += ("<g " + FamilyTree.attr.s_link_from + '="{from}" ' + FamilyTree.attr.s_link_to + '="{to}">').replace("{from}", U).replace("{to}", B) + p.link.replaceAll("{d}", L) + '<path stroke="transparent" stroke-width="15" fill="none" d="' + L + '" />', i += FamilyTree.grCloseTag
  }
  ...
  if (e.config.miniMap) {
    if (e.manager.action != FamilyTree.action.move) {
      ...
      l.onmousedown = function (e) {
        ...
        if (s) {
          t.preventDefault(), t.stopPropagation(), FamilyTree.miniMap._mouseMove = !0;
          ...
          i[0] = p + i[0], i[1] = f + i[1], e.setViewBox(i), d && (clearTimeout(d), d = null), d = setTimeout((function () {
        ...
        s && (e.preventDefault(), e.stopPropagation(), s = !1, FamilyTree.miniMap._mouseMove = !1)
      }, l.onclick = function (t) {
        if (t.preventDefault(), t.stopPropagation(), FamilyTree.miniMap._mouseMove) FamilyTree.miniMap._mouseMove = !1;
        else {
          ...
          i[0] = c - (i[0] + i[2] - i[0]) / 2 - FamilyTree.miniMap._settings._translateX / FamilyTree.miniMap._settings._scale, i[1] = m - (i[1] + i[3] - i[1]) / 2 - FamilyTree.miniMap._settings._translateY / FamilyTree.miniMap._settings._scale, e.setViewBox(i), d && (clearTimeout(d), d = null), d = setTimeout((function () {
            e._draw(!0, FamilyTree.action.move)
          }), 300), FamilyTree.miniMap._drawRectSelectorCanvas(e, i)
        }
      }
    }
  } else {
  ...
  if (!e.element.querySelector('[data-id="mini-map"]')) {
    ...
    FamilyTree.miniMap.draggable && r.addEventListener("mousedown", (function (e) {
      d = e.clientX, c = e.clientY, document.addEventListener("mousemove", m), document.addEventListener("mouseup", h)
    }))
  }
    ...
    for (var p = e[h], f = 0; f < i.length; f++) {
      ...
      if (!FamilyTree.isNEU(p[u])) {
        ...
        if (null != (t = FamilyTree._search.searchAndComputeScore(d, y, u, n))) {
          ...
          } else m[g] = t.__score, FamilyTree._search.addNodeToResult(l, r, p, t, u, a)
        }
      }
    }
  ...
  for (p = n.length - 1; p >= 0; p--)
    for (m = 0; m < n.length; m++) m < p && n[m].start + n[m].length > n[p].start && n.splice(p, 1);
  var T = t;
  for (p = n.length - 1; p >= 0; p--) T = (T = T.insert(n[p].start + n[p].length, "</mark>")).insert(n[p].start, "<mark>");
  return {
    __searchMarks: T,
    __score: v
  }
  ...
  return a.doNotRender ? {
    ...
    html: `<div class="bft-form-field" style="min-width: ${i};">\n                    <div class="bft-input" data-bft-input="" ${a.disabledAttribute} ${a.vlidators}>\n                        <label for="${a.id}">${FamilyTree._escapeGreaterLessSign(a.label)}</label>\n                        <select class="multiple" data-binding="${FamilyTree._escapeDoubleQuotes(a.binding)}" ${a.readOnlyAttribute} id="${a.id}" name="${a.id}" multiple>\n                            ${function () { for (var e = "", t = 0; t < a.options.length; t++) { var i = a.options[t]; e += `<option ${a.value.includes(i.value) ? "selected" : ""} value="${FamilyTree._escapeDoubleQuotes(i.value)}">${FamilyTree._escapeGreaterLessSign(i.text)}</option>` } return e }()}                           \n                        </select>\n                    </div>\n                </div>`,
    id: a.id,
    value: a.value
  }
  ...
  if (n) m.push(n);
    ...
    var h = {
      ...
      _ft_data: {
        gender: "female",
        img: "https://giaphaviet.kennatech.vn/public/assets/images/gender/woman.jpg"
      }
    };
    c.mid = h.id, a ? (a.pids = [h.id], h.pids = [a.id], h._ft_data.pids = [a.id]) : h.pids = ["_ft_father"], m.push(h)
  }
  if (a) m.push(a);
  else {
    var p = {
      ...
      _ft_data: {
        gender: "male",
        img: "https://giaphaviet.kennatech.vn/public/assets/images/gender/man.jpg"
      }
    };
    c.fid = p.id, n ? (n.pids = [p.id], p.pids = [n.id], p._ft_data.pids = [n.id]) : p.pids = ["_ft_mother"], m.push(p)
  }
  ...
  var f = {
    ...
    _ft_data: {
      pids: [e],
      img: "https://giaphaviet.kennatech.vn/public/assets/images/gender/default.jpg"
    }
  };
        ...
        var u = {
          ...
          y = {
            ...
            _ft_childData: {
              ...
              fid: f.id,
              gender: "female",
              img: "https://giaphaviet.kennatech.vn/public/assets/images/gender/female.jpg"
            },
            _ft_partnerData: {
              pids: [e]
            },
  ...
  if (this.instance.config.filterBy) {
    ...
    this.element.innerHTML = `<div>${f}</div>`, this.element.addEventListener("click", (function (e) {
      if (e.target.hasAttribute("data-filter-close") || e.target.hasAttribute("data-filter-field")) {
        for (var t = e.target.getAttribute("data-filter-field"), i = p.instance.element.querySelectorAll("[data-filter-menu]"), r = 0; r < i.length; r++) i[r].style.display = "none";
        ...
        var o = p.instance.element.querySelector(`[data-filter-menu="${t}"]`);
        if (!o) {
          var l = {
            name: t,
            text: "[All]",
          ...
          for (var d in p.filterBy[t]) {
            ...
            null == m && (m = d), l = {
              ...
              value: d,
              checked: c.checked,
              html: `<div>\n                            <input  type="checkbox" id="${d}" name="${d}" ${c.checked ? "checked" : ""}>\n                            <label for="${d}">${m}</label>\n                        </div>`
            }, FamilyTree.events.publish("add-item", [p, l]), s += l.html
          }
          o = document.createElement("div");
          ...
          for (r = 0; r < f.length; r++) f[r].addEventListener("change", (function (e) {
            ...
            if (t) {
              ...
              if (e.target.hasAttribute("data-all")) {
                for (var r = e.target.parentNode.parentNode.querySelectorAll("input"), a = 0; a < r.length; a++)
                  if (r[a] != e.target)
                    for (var n in r[a].checked = e.target.checked, p.filterBy[i]) p.filterBy[i][n].checked = e.target.checked
              } else if (null != p.filterBy[i][this.name] && (p.filterBy[i][this.name].checked = this.checked), this.checked)
                for (var o = p.instance.config.nodes, l = 0; l < o.length; l++)
                  if (o[l][i] == this.name)
                    for (var s = o[l]; s;)
                      if (FamilyTree.isNEU(s.stpid)) s = FamilyTree.isNEU(s.pid) ? null : p.instance._get(s.pid);
                      else if ((s = p.instance._get(s.stpid))[i]) {
                        var d = e.target.parentNode.parentNode.querySelector('[name="' + s[i] + '"]');
                        d ? (d.checked = this.checked, p.filterBy[i][s[i]].checked = this.checked) : console.error('Cannot find element with selector: [name="' + s[i] + '"]')
                      }
              p.instance.draw()
            }
          }))
        }
        o.style.display = "block", e.target.classList.add("filter-field-selected"), (n = document.createElement("div")).classList.add("close"), n.innerHTML = "x", n.setAttribute("data-filter-close", ""), e.target.parentNode.appendChild(n), FamilyTree.events.publish("show-items", [p, {
          name: t
        }])
      }
  ...
  return FamilyTree.events.on(e, t, this._event_id), this
}, FamilyTree.filterUI.textFilterBy = "Filter by", void 0 === FamilyTree && (FamilyTree = {}), void 0 === FamilyTree.remote && (FamilyTree.remote = {}), FamilyTree.LIMIT_NODES = !0, FamilyTree.remote._fromResDTO = function (e, t, i, r, a) {
  var n = t[e.id];
...
FamilyTree.remote._convertToIdArray = function (e) {
  ...
  if (t) e(t);
    ...
    for (var i = ["defunc2", "cusfunc2", "bsfunc2", "acfunc2", "kcfunc2", "safunc2", "wifunc2"], r = [], a = 0; a < i.length; a++) r.push(new XMLHttpRequest);
