...
OrgChart._defaultConfig = function (t) {
    ...
    if (!OrgChart.LAZY_LOADING || this.isVisible) if (OrgChart.LAZY_LOADING || this._initialized || (this._setInitialSizeIfNotSet(), 0 != this.width() && 0 != this.height())) {
        ...
        this.manager.read(t, this.width(), this.height(), n, e, r, (function (t) {
            if (!a.notifierUI.show(t.notif)) {
                ...
                var d = [];
                if (OrgChart.RENDER_LINKS_BEFORE_NODES) for (var c = 0; c < t.visibleNodeIds.length; c++) {
                ...
                if (OrgChart.events.publish("render", [a, n]), o = n.content, t = n.res, o += a.ui.lonely(a.config), e !== OrgChart.action.exporting) {
                    ...
                    var m = !1, C = a.response.animations;
                    if (C[0].length > 0) {
                    ...
                    var b = t.boundary, O = b.maxX - b.minX, v = b.maxY - b.minY,
                        y = a.ui.svg(O, v, [b.minX, b.minY, O, v], a.config, o, l);
                    i(y, t)
                }
            }
        }), (function (t) {
    ...
    var e = this.getViewBox().slice(0), r = this.width(), i = this.height(), a = r / e[2], n = i / e[3],
        o = a > n ? n : a, l = e, s = e[2], h = e[3];
    ...
    if (null != i) {
        ...
        if (null != a) {
            ...
            var h = i.w, d = i.h, c = h - o > o ? h - o : o, g = d - l > l ? d - l : l, p = c > g ? c : g,
    ...
    var c = this.width(), g = this.height(), p = c / (b = n - l + 2 * this.config.padding),
        u = g / (O = o - s + 2 * this.config.padding), f = p > u ? u : p, m = Math.ceil(c / f), C = Math.ceil(g / f),
        b = 0, O = 0;
    if (m - 2 * this.config.padding >= n - l) b = (n + l) / 2 - m / 2; else switch (b = firstRoot.x - m / 2 + OrgChart.manager._getNodeWidth(firstRoot, this.config) / 2, this.config.orientation) {
    ...
    if (C - 2 * this.config.padding >= o - s) O = (o + s) / 2 - C / 2; else switch ((O = -(C / 2 - (o - s) / 2)) > -this.config.padding && (O = -this.config.padding), this.config.orientation) {
    ...
    var v = [b, O, m, C];
    a[0] !== v[0] || a[1] !== v[1] ? OrgChart.animate(i, {viewBox: a}, {viewBox: v}, this.config.anim.duration, this.config.anim.func, (function () {
    ...
    if (Array.isArray(this.config.roots)) for (r = 0; r < this.config.roots.length; r++) OrgChart.isNEU(t[this.config.roots[r]]) || (this.config.roots[r] = t[this.config.roots[r]]);
    if (this.nodes) for (var o in this.nodes) if (!OrgChart.isNEU(t[o])) {
        n = t[o];
        (l = this.nodes[o]).id = n, this.nodes[n] = l
    }
    if (this.manager.oldNodes) for (var o in this.manager.oldNodes) if (!OrgChart.isNEU(t[o])) {
        n = t[o];
        (l = this.manager.oldNodes[o]).id = n, this.manager.oldNodes[n] = l
    }
    if (this.roots) for (var o in this.roots) if (!OrgChart.isNEU(t[o])) {
        var l;
        n = t[o];
    ...
    this.obj.element.querySelector("[data-add-more-fields-btn]").addEventListener("click", (function (t) {
        ...
        a.focus(), a.nextElementSibling.addEventListener("click", (function (t) {
            ...
            if (OrgChart.isNEU(r) || n) a.focus(); else {
    ...
    var n, o = this.obj.config.editForm.readOnly, l = JSON.parse(JSON.stringify(this.obj.config.editForm.elements)),
        ...
        d = this.obj.config.editForm.cancelBtn, c = this.obj.config.editForm.buttons,
        ...
        if ("tags" != v) {
            for (var y = !1, x = 0; x < l.length; x++) {
                if (Array.isArray(l[x])) {
                    for (var _ = 0; _ < l[x].length; _++) if (v == l[x][_].binding) {
                        y = !0;
                        break
                    }
    ...
    var L = [], N = a ? "" : OrgChart.EDITFORM_CLOSE_BTN;
        ...
        for (var t = "", r = 0; r < l.length; r++) {
            ...
            if (Array.isArray(i)) {
                ...
                for (var a = 0; a < i.length; a++) {
                    ...
                    !OrgChart.isNEU(s.id) && OrgChart.isNEU(n) && OrgChart.isNEU(s.value) && (n = s.id), OrgChart.isNEU(s.value) || L.push(`${o.label}: ${s.value}`), t += s.html
                }
                t += "</div>"
            } else {
                s = OrgChart.elements[i.type](f, i, "280px", e);
                !OrgChart.isNEU(s.id) && OrgChart.isNEU(n) && OrgChart.isNEU(s.value) && (n = s.id), OrgChart.isNEU(s.value) || L.push(`${i.label}: ${s.value}`), t += s.html
            }
        }
        return t
        ...
        for (var u = this.wrapper.getElementsByTagName("div"), f = 0; f < u.length; f++) {
            (s = u[f]).addEventListener("click", (function (t) {
                ...
                if (void 0 === a[o].onClick) if ("add" === o) {
                    ...
                    expandChildren: !1,
                    nodeId: r
                }) : "csv" === o ? n.obj.exportCSV({nodeId: r}) : "xml" === o ? n.obj.exportXML({nodeId: r}) : "json" === o && n.obj.exportJSON({nodeId: r}); else e = a[o].onClick.call(n.obj, r, i);
                0 != e && n.hide()
            }))
        }
    }
    ...
    if (!OrgChart.isNEU(a.nodeCircleMenuButton)) {
        var n = this.obj.getSvg(),
            ...
            d = s[4] + h[4], c = s[5] + h[5], g = o.querySelectorAll("line"),
        ...
        if (OrgChart.isNEU(p) || p.getAttribute(OrgChart.attr.control_node_circle_menu_wrraper_id) != t) {
            ...
            for (var y in (p = document.createElementNS("http://www.w3.org/2000/svg", "g")).setAttribute(OrgChart.attr.control_node_circle_menu_wrraper_id, t), p.setAttribute("transform", "matrix(1,0,0,1," + d + "," + c + ")"), n.appendChild(p), u.menu) {
                var x = u.menu[y].icon, _ = u.menu[y].color, w = u.menu[y].text;
                ...
                if (A.setAttribute("pointer-events", "none"), A) {
                    var L = parseInt(A.getAttribute("width")), N = parseInt(A.getAttribute("height"));
    ...
    var r = this, i = {id: t.nodeId, expandChildren: t.expandChildren, min: t.min};
    t.margin && t.margin[0] < 2 && (t.margin[0] = 2), t.margin && t.margin[1] < 2 && (t.margin[1] = 2), t.margin && t.margin[2] < 2 && (t.margin[2] = 2), t.margin && t.margin[3] < 2 && (t.margin[3] = 2), this._draw(!1, OrgChart.action.exporting, i, (function (i, a) {
        ...
        if (n.innerHTML = i, t.padding > 0) {
            var o = n.querySelector("svg"), l = OrgChart._getViewBox(o);
        ...
        if ("svg" == t.ext) if (e) e(t, n.innerHTML); else {
            (o = n.querySelector("svg")).classList.add("boc-" + r.config.mode);
            var s = {content: n.innerHTML, options: t, styles: ""}, h = OrgChart.events.publish("exportstart", [r, s]),
            ...
            var a = {content: n.innerHTML, options: t, pages: i, styles: ""},
                o = OrgChart.events.publish("exportstart", [r, a]), l = r.element.querySelector("[data-boc-styles]");
    ...
    var e = OrgChart._defaultExportProfileOptionsForCSV_SVG_JSON(t, "csv"), r = this.getNode(e.nodeId), i = null;
    ...
    var n = OrgChart._json2csv(a.nodes), o = {ext: a.ext, filename: a.filename, options: e, nodes: a.nodes, content: n};
    ...
    var e = OrgChart._defaultExportProfileOptionsForCSV_SVG_JSON(t, "xml"), r = this.getNode(e.nodeId), i = null;
    r ? (i = [], OrgChart._exportIterateForJSON_XML_CSV(this, r, e, i)) : !1 === e.min || !1 === e.expandChildren ? OrgChart._exportIterateForJSON_XML_CSV(this, this.roots, e, i) : i = JSON.parse(JSON.stringify(this.config.nodes));
    var a = {ext: "xml", filename: t, options: e, nodes: i};
    if (!1 === OrgChart.events.publish("exportstart", [this, a])) return !1;
    var n = OrgChart._json2xml(a.nodes), o = {ext: a.ext, filename: a.filename, options: e, nodes: a.nodes, content: n};
    if (!1 === OrgChart.events.publish("exportend", [this, o])) return !1;
    ...
    var e = OrgChart._defaultExportProfileOptionsForCSV_SVG_JSON(t, "json"), r = this.getNode(e.nodeId), i = null;
    r ? (i = [], OrgChart._exportIterateForJSON_XML_CSV(this, r, e, i)) : !1 === e.min || !1 === e.expandChildren ? OrgChart._exportIterateForJSON_XML_CSV(this, this.roots, e, i) : i = JSON.parse(JSON.stringify(this.config.nodes));
    ...
    if (Array.isArray(e)) for (var a = 0; a < e.length; a++) OrgChart._exportIterateForJSON_XML_CSV(t, e[a], r, i); else {
        var n = t.get(e.id);
        if (i.push(n), r.min) for (a = 0; a < e.stChildrenIds.length; a++) OrgChart._exportIterateForJSON_XML_CSV(t, t.getNode(e.stChildrenIds[a]), r, i); else for (a = 0; a < e.stChildren.length; a++) OrgChart._exportIterateForJSON_XML_CSV(t, e.stChildren[a], r, i);
        if (r.expandChildren) for (a = 0; a < e.childrenIds.length; a++) OrgChart._exportIterateForJSON_XML_CSV(t, t.getNode(e.childrenIds[a]), r, i); else for (a = 0; a < e.children.length; a++) OrgChart._exportIterateForJSON_XML_CSV(t, e.children[a], r, i)
    }
    ...
    var i = e.getAttribute("width"), a = 0, n = 0;
    switch (t.format) {
        case"A5":
    ...
    var a = OrgChart._getViewBox(e), n = 0, o = 0;
    switch (t.format) {
        case"A5":
    ...
    var p = c.w * (100 / r), u = c.h * (100 / r), f = l, m = s, C = [], b = !0;
    if (!OrgChart.EXPORT_PAGES_CUT_NODES && "fit" == t.scale) {
        e.setAttribute("preserveAspectRatio", "xMinYMin");
        for (var O = Object.keys(i.bordersByRootIdAndLevel), v = i.bordersByRootIdAndLevel[O[0]], y = Object.keys(v).length, x = 1; x < O.length; x++) y < Object.keys(i.bordersByRootIdAndLevel[O[x]]).length && (v = i.bordersByRootIdAndLevel[O[x]], y = Object.keys(v).length);
        for (var _ = 0, w = 0; ;) {
            for (w = _; !(y <= _);) {
    ...
    if (!b || OrgChart.EXPORT_PAGES_CUT_NODES || "fit" != t.scale) for (e.setAttribute("preserveAspectRatio", "xMinYMin slice"), C = []; f < h + l;) {
        for (; m < d + s;) {
            var I;
            I = (I = [f, m, p, u]).join(), C.push({vb: I, innerSize: c, size: g}), m += u
        }
        f += p, m = s
    }
    return C
    ...
    return OrgChart.isNEU(t) && (t = {}), "string" == typeof t && (t = {filename: t}), OrgChart.isNEU(t.filename) && (t.filename = `OrgChart.${e}`), OrgChart.isNEU(t.expandChildren) && (t.expandChildren = !0), OrgChart.isNEU(t.min) && (t.min = !0), OrgChart.isNEU(t.openInNewTab) && (t.openInNewTab = !1), t
    ...
    return {
        on: function (e, r, i) {
            ...
            var a = !1;
            if (t[e] && Array.isArray(t[e]) && t[e].length > 0) for (var n = t[e].length - 1; n >= 0; n--) (!OrgChart.isNEU(i) && !OrgChart.isNEU(r) && t[e][n].event_id == i && t[e][n].listener == r || !OrgChart.isNEU(i) && OrgChart.isNEU(r) && t[e][n].event_id == i || OrgChart.isNEU(i) && !OrgChart.isNEU(r) && t[e][n].listener == r || OrgChart.isNEU(i) && OrgChart.isNEU(r)) && (t[e].splice(n, 1), a = !0);
            return a
        }, has: function (e, r) {
    ...
    var o = this.element.getBoundingClientRect(), l = e.clientX - o.left, s = e.clientY - o.top;
    ...
    if (n.draggable) {
        ...
        t._dragEventFired = !1;
        var h = o.getScale(), d = null, c = null;
        ...
        var O = function (t, e) {
            ...
            if (p) {
                ...
                if (s.left || s.right || s.up || s.down) {
                    ...
                    var v = f[4], x = f[5], _ = p.x, w = p.y, k = r.x, S = r.y;
    ...
    var i = t.getAttribute(OrgChart.attr.node_id), a = this.getNode(i);
    ...
    var i = this, a = t.getAttribute(OrgChart.attr.node_id), n = [], o = function (t, e) {
        if (Array.isArray(t)) for (var r = 0; r < t.length; r++) o(t[r], e); else {
            e.push(t.id);
    ...
    o(s, n);
    for (var h = this.getSvg(), d = OrgChart._getClientXY(e), c = [], g = [], p = [], u = [], f = [], m = [], C = [], b = [], O = 0; O < n.length; O++) {
        var v = this.getNode(n[O]);
        c.push(v), p.push({x: v.x, y: v.y});
        var y = this.getNodeElement(n[O]);
        if (y) {
            f.push(y);
            var x = OrgChart._getTransform(y);
            u.push({x: x[4], y: x[5]}), g.push(x);
            var _ = this.element.querySelector(`[data-ctrl-ec-id="${n[O]}"]`);
            if (_) {
                m.push(_);
                var w = OrgChart._getTransform(_);
                C.push(w), b.push({x: w[4], y: w[5]})
            } else m.push(null), C.push(null), b.push(null);
    ...
    var I = {x: d.x, y: d.y}, A = i.getScale(), L = function (t, e) {
        if (null != t) {
            e.classList.remove("boc-drag-over");
        ...
        if (I) {
            var r = OrgChart._getClientXY(e), o = e.target;
            OrgChart.isMobile() && (o = document.elementFromPoint(r.x, r.y));
            var l = OrgChart._getOffsetXY(i.element, e), d = {
            ...
            if (d.left || d.right || d.up || d.down) {
                ...
                for (var O = [], v = [], y = [], x = [], _ = 0; _ < g.length; _++) O.push(g[_][4]), v.push(g[_][5]), C[_] ? (y.push(C[_][4]), x.push(C[_][5])) : (y.push(null), x.push(null));
                var w = I.x, N = I.y, M = r.x, T = r.y;
                i.moveStart(d, (function (t) {
                    for (var e = 0; e < g.length; e++) {
                        var a = O[e], n = v[e], o = y[e], l = x[e];
                        ...
                        if (c[e].parent) for (s = OrgChart.ui.link(c[e].parent, i, A, i.response.bordersByRootIdAndLevel, i.nodes, OrgChart.action.update, !0), h = 0; h < s.length; h++) {
                            var p;
                            d = s[h];
                            (p = i.element.querySelector(`[data-l-id="[${d.id}][${d.childId}]"]`)) && (p.innerHTML = d.html)
                        }
                ...
                if (i.moveEnd(), h.classList && (h.classList.add("boc-cursor-grab"), h.classList.remove("boc-cursor-move"), h.classList.remove("boc-cursor-nodrop"), h.classList.remove("boc-cursor-copy")), L(k, S), k = null, S = null, i.config.enableDragDrop) for (; null != o && o != h;) {
                ...
                var H = (r.x - I.x) / A, D = (r.y - I.y) / A;
                for (_ = 0; _ < g.length; _++) {
                    g[_][4] = u[_].x + H, g[_][5] = u[_].y + D, C[_] && (C[_][4] = b[_].x + H, C[_][5] = b[_].y + D), c[_].x = p[_].x + H, c[_].y = p[_].y + D, c[_].movex = H, c[_].movey = D;
                ...
                if (s.parent) if (i.config.movable == OrgChart.movable.detachTree) (Y = i.element.querySelector(`[data-l-id="[${s.parent.id}][${s.id}]"]`)) && Y.parentElement.removeChild(Y); else for (z = OrgChart.ui.link(s.parent, i, A, i.response.bordersByRootIdAndLevel, i.nodes, OrgChart.action.update, !0), P = 0; P < z.length; P++) {
                    var Y;
                    j = z[P];
                    (Y = i.element.querySelector(`[data-l-id="[${j.id}][${j.childId}]"]`)) && (Y.innerHTML = j.html)
                }
                if (!t._dragEventFired && (Math.abs(r.x - I.x) > OrgChart.FIRE_DRAG_NOT_CLICK_IF_MOVE || Math.abs(r.y - I.y) > OrgChart.FIRE_DRAG_NOT_CLICK_IF_MOVE)) {
                    if (!1 === OrgChart.events.publish("drag", [i, a, e, n]) && E(), i.config.enableDragDrop) for (_ = 0; _ < f.length; _++) h.insertBefore(f[_], h.firstChild);
                    t._dragEventFired = !0
                }
        ...
        if (i.moveEnd(), h.classList && (h.classList.remove("boc-cursor-grab"), h.classList.remove("boc-cursor-move"), h.classList.remove("boc-cursor-nodrop"), h.classList.remove("boc-cursor-copy")), h.removeEventListener(r.move, N), h.removeEventListener(r.up, E), r.leave && h.removeEventListener(r.leave, E), c[0].id != k && null != k) {
            ...
            if (i.canUpdateLink(c[0].id, k)) (C = i.get(c[0].id)).pid = k, C.stpid = null, i.updateNode(C, null, !0); else L(k, S);
            i._gragStartedId = null
        } else {
            if (t._dragEventFired) {
                var o = OrgChart.events.publish("drop", [i, c[0].id, void 0, f[0], e]);
                if (i.config.movable && !1 !== o) if (i.config.movable == OrgChart.movable.detachTree) {
                    var d = OrgChart._getTransform(i.getNodeElement(s.id));
                    (C = i.get(s.id)).pid = null, C.stpid = null, i.updateNode(C, null, !0)
                } else {
                    var g = [];
                    l(s, g);
                    var u = (d = OrgChart._getTransform(i.getNodeElement(s.id)))[4] - s.x, m = d[5] - s.y;
                    for (a = 0; a < g.length; a++) {
                        var C;
                        (C = i.get(g[a])) && (null != C.movex ? C.movex += u : C.movex = u, null != C.movey ? C.movey += m : C.movey = m, i.update(C))
                    }
                    OrgChart.events.publish("updated", [i]), i.draw(OrgChart.action.update, {dragNodeIdList: g})
                }
            }
            i._gragStartedId = null
        }
    ...
    var s = this, h = this.getSvg(), d = {x: i.x, y: i.y}, c = OrgChart._getTransform(t), g = c[4], p = c[5],
    ...
    var m = function (t, e) {
        ...
        if (d) {
            ...
            if (C.left || C.right || C.up || C.down) {
                h.classList && (h.classList.remove("boc-cursor-grab"), h.classList.add("boc-cursor-move"), h.classList.remove("boc-cursor-nodrop"), h.classList.remove("boc-cursor-copy"));
                var O = c[4], v = c[5], y = d.x, x = d.y, _ = r.x, w = r.y;
                ...
                if (s.moveEnd(), h.classList && (h.classList.add("boc-cursor-grab"), h.classList.remove("boc-cursor-move"), h.classList.remove("boc-cursor-nodrop"), h.classList.remove("boc-cursor-copy")), m(o, l), o = null, l = null, s.config.enableDragDrop) for (; null != i && i != h;) {
                    if (i.hasAttribute && i.hasAttribute(OrgChart.attr.node_id)) {
    ...
    if (t) {
        if (!this._moveInterval) {
            var a = this, n = this.getViewBox().slice(0), o = this.getScale(), l = 0, s = 0, h = 1;
    ...
    var i = this.getPointerElement(), a = OrgChart._getOffsetXY(this.element, r), n = a.x / e + t[0] - 16 / e,
        o = a.y / e + t[1] - 16 / e;
    i.style.display = "inherit", i.setAttribute("transform", "matrix(0,0,0,0," + n + "," + o + ")"), OrgChart.animate(i, {
        transform: [0, 0, 0, 0, n, o],
        opacity: 0
    }, {transform: [1 / e, 0, 0, 1 / e, n, o], opacity: 1}, 300, OrgChart.anim.outBack)
    ...
    var e = this, r = this.instance.config.padding - 10, i = this.instance.config.padding - 10,
    ...
    var t, e = this;
    if (this._searchAfterEnterPress = !1, this.input.value == OrgChart.SEARCH_HELP_SYMBOL) t = this.helpView(); else {
        this.__search();
        ...
        t = `<table border="0" cellspacing="0" cellpadding="0">\n                        <tbody>\n                            ${function () {
            for (var t = "", i = 0; i < e.lastSearch.length && !(i >= OrgChart.SEARCH_RESULT_LIMIT); i++) {
                var a = e.lastSearch[i], n = "";
                if (r) {
                    var o = e.instance._get(a.id);
                    "function" == typeof r ? n = r(e.instance, e.instance.getNode(a.id), o) : o[r] && (n = o[r])
                }
                var l = "", s = "";
                e.instance.config.searchDisplayField == a.__searchField ? l = a.__searchMarks : e.instance.config.searchDisplayField ? (l = a[e.instance.config.searchDisplayField], OrgChart.isNEU(l) && (l = ""), s = a.__searchMarks) : l = a.__searchMarks;
                var h = {
                    img: n,
                    nodeId: a.id,
                    first: l,
    ...
    OrgChart.state._get(this.config.state, e, r, (function (h) {
        ...
        var d = s.maxX, c = s.maxY, g = s.minX, p = s.minY, u = s.bordersByRootIdAndLevel, f = s.roots, m = s.nodes;
        if (t) {
    ...
    var l = o.manager.config, s = o.manager.layoutConfigs, h = o.manager.action, d = o.manager.actionParams,
        c = o.manager.state, g = s[r || "base"];
    ...
    if (h != OrgChart.action.minimize || t.min ? h == OrgChart.action.maximize && !0 === t.min ? (d.all || d.id == t.id) && (t.min = !1) : h == OrgChart.action.exporting && !1 === d.min ? t.min = !1 : h == OrgChart.action.init && null != c && (t.min = c.min.has(t.id)) : (d.all || d.id == t.id) && (t.min = !0), !t.min) for (p = 0; p < t.stChildrenIds.length; p++) {
    ...
    for (var s = [], h = OrgChart._addDottedLines(r), d = 0; d < h.length; d++) {
        ...
        var u = OrgChart._getTemplate(c, r.tags, r.template), f = new OrgChart.node(g.id, g.pid, c, u);
    ...
    for (d = 0; d < s.length; d++) {
        var m = s[d], C = (f = t[m], n ? n[m] : null), b = t[f.stpid], O = t[f.pid];
    ...
    if (OrgChart.manager.__createNodes(l, s, e, i, a, n, h, t), null != e.roots) {
        ...
        for (var d = 0; d < e.roots.length; d++) {
            ...
            if (c) {
                for (var u = !1, f = 0; f < s.length; f++) if (s[f].id == c.id) {
                    u = !0;
                    break
                }
                if (!u) {
    ...
    var m = [];
    if (i == OrgChart.action.init && e.expand && e.expand.nodes && null == o) for (d = 0; d < e.expand.nodes.length; d++) {
        ...
        for (var O = l[a.id]; O;) {
            if (m.push(O.id), a.options.parentState === OrgChart.COLLAPSE_PARENT_NEIGHBORS && O) for (d = 0; d < O.childrenIds.length; d++) {
                (H = l[O.childrenIds[d]]).collapsed = !0
            }
            null == O.pid && null != O.stpid ? (O = l[O.stpid]).min = !1 : O = l[O.pid]
        }
        O = l[a.id];
        if (a.options.childrenState === OrgChart.COLLAPSE_SUB_CHILDRENS) for (d = 0; d < O.childrenIds.length; d++) {
            (y = l[O.childrenIds[d]]).collapsed = !1;
            for (var v = 0; v < y.childrenIds.length; v++) {
                l[y.childrenIds[v]].collapsed = !0
            }
        }
        if (a.options.parentState === OrgChart.COLLAPSE_PARENT_SUB_CHILDREN_EXCEPT_CLICKED) if (b = l[O.pid]) for (d = 0; d < b.childrenIds.length; d++) {
            var y;
    ...
    if (i == OrgChart.action.collapse && a && Array.isArray(a.expandIds) && Array.isArray(a.collapseIds)) for (d = 0; d < a.ids.length; d++) {
        if (a.expandIds.has(a.collapseIds[d])) console.error(`id ${a.collapseIds[d]} exist in both collapseIds and expandIds`); else (C = l[a.collapseIds[d]]) && (C.collapsed = !0)
    }
    for (d = s.length - 1; d >= 0; d--) s[d].collapsed && s.splice(d, 1);
    for (d = 0; d < S.length; d++) {
        C = l[S[d]];
        var I = [], A = [], L = [], N = {}, E = 0, M = 0, T = 0, B = [], U = [];
        ...
        for (v = L.length - 1; v >= 0; v--) if (N[L[v]]) for (f = 0; f < N[L[v]].length; f++) C.children.push(l[N[L[v]][f]]), M++, -1 == U.indexOf(L[v]) && U.push(L[v]);
        for (v = 0; v < I.length; v++) {
            var H = l[I[v]];
            C.children.push(H)
        }
        for (v = 0; v < A.length; v++) if (N[A[v]]) for (f = 0; f < N[A[v]].length; f++) C.children.push(l[N[A[v]][f]]), T++, -1 == B.indexOf(A[v]) && B.push(A[v]);
    ...
    for (var j in _) {
        ...
        for (v = b.children.length - 1; v >= 0; v--) {
            (H = b.children[v]).isAssistant ? (H.parent = null, b.children.splice(v, 1), Y.splice(0, 0, H.id)) : H.isPartner || (H.parent && k[H.parent.id] && z && H.parent.id != z.id && (Object.defineProperty(k, z.id, Object.getOwnPropertyDescriptor(k, H.parent.id)), delete k[H.parent.id]), H.parent = z, z.children.unshift(H), b.children.splice(v, 1))
        }
        if (Y.length % 2) {
            var q = l[Y[Y.length - 1]], $ = new OrgChart.node(q.id + "_mirror", b.pid, [], "mirror");
            OrgChart.manager._initDinamicNode($, q.lcn, !0), $.isAssistant = !0, $.w = q.w, $.h = q.h, l[$.id] = $, Y.splice(Y.length - 1, 0, $.id)
        }
        var X = 1;
        for (v = Y.length - 1; v >= 0; v--) if (v % 2 && v != Y.length - 1) {
            var V = new OrgChart.node(b.id + "_split_assitant_" + X, b.pid, [], "split");
            OrgChart.manager._initDinamicNode(V, b.lcn, !0), l[V.id] = V, Y.splice(v, 0, V.id), X++
        } else v % 2 && Y.splice(v, 0, z.id);
        for (v = 0; v < Y.length; v += 3) {
            var G = null;
            G = 0 == v ? b : l[Y[v - 2]];
            var W = l[Y[v]], J = l[Y[v + 1]], K = l[Y[v + 2]];
    ...
    if (Z || tt) {
        ...
        if (w.length) {
            ...
            if (rt) {
                ...
                for (var j in k = {}, nt) if (nt[j].length > OrgChart.MIXED_LAYOUT_IF_NUMBER_OF_CHILDREN_IS_MORE_THEN) {
                    var dt = ot[j];
        ...
        for (var j in k) {
            ...
            if (0 != (D = r[b.lcn ? b.lcn : "base"]).layout || tt) {
                et.pnode = b, et.layout = D.layout, et.layoutGridColumns = e.layoutGridColumns, et.childrenIds = k[j], et.lastChildrenPidIds = k, et.subLevels = 0, et.layouts = [], OrgChart.events.publish("node-layout", [t, et]), OrgChart.events.publish("layout", [et]), et.layouts.length || et.layouts.push({
                    layout: et.layout,
                ...
                for (var gt = 0; gt < et.layouts.length; gt++) {
                    ...
                    if (pt.layout == OrgChart.layout.grid && pt.childrenIds.length > 2) {
                        ...
                        var mt = b.id;
                        for (d = b.children.length - 1; d >= 0; d--) for (v = 0; v < pt.childrenIds.length; v++) {
                            ht = pt.childrenIds[v];
                            if (b.children[d].id == ht) {
                        ...
                        for (d = 0; d < pt.childrenIds.length; d += Ct) {
                            var bt = null;
                            for (v = 0; v < Ct; v++) {
                                var Ot = d + Ct >= pt.childrenIds.length;
                                if (pt.childrenIds.length - 1 < d + v) break;
                                (H = l[ht = pt.childrenIds[d + v]]).parent = l[mt], l[mt].children.push(H), Ot || (Ct / 2 - 1 == v && (bt = new OrgChart.node(pt.childrenIds[d + v - 1] + "_grid_pseudo_node_" + pt.childrenIds[d + v + 1], mt, [], "subLevel"), OrgChart.manager._initDinamicNode(bt, b.lcn), bt.parent = l[mt], l[mt].children.push(bt), l[bt.id] = bt), Ct - 1 == v && (mt = bt.id))
                            }
                        }
                    }
                    if (pt.layout == OrgChart.layout.mixed) {
                        ...
                        for (d = vt.length - 1; d >= 0; d--) {
                            b = (H = l[vt[d]]).parent, H.layout = OrgChart.layout.mixed;
                            for (v = b.children.length - 1; v >= 0; v--) if (H.id == b.children[v].id) {
                        ...
                        for (X = 1, v = xt.length - 1; v >= 0; v--) if (v % 2 && v != xt.length - 1) {
                            V = new OrgChart.node(gt + "_" + b.id + "_split_" + X, ct.id, [], "split");
                            OrgChart.manager._initDinamicNode(V, b.lcn), V.layout = pt.layout, l[V.id] = V, xt.splice(v, 0, V.id), X++
        ...
        if (e.lazyLoading && i !== OrgChart.action.exporting) {
            function a(t, e) {
                var r = t.x, i = t.y, a = t.w, n = t.h, o = e[0] - OrgChart.LAZY_LOADING_FACTOR,
                    ...
                    h = e[3] + OrgChart.LAZY_LOADING_FACTOR + e[1], d = r + a > o && l > r;
    ...
    for (r = 0; r < t.nodes.length; r++) for (var i in t.nodes[r]) i !== OrgChart.ID && i !== OrgChart.TAGS && i !== OrgChart.NODES && i !== OrgChart.PID && i !== OrgChart.STPID && "movex" !== i && "movey" !== i && (t.nodeBinding[i] || e.has(i) || e.push(i));
    return e
    ...
    if (C.top = l - i.padding, C.left = o - i.padding, C.bottom = n + i.padding - e / y, C.right = a + i.padding - t / y, C.maxX = a, C.minX = o, C.maxY = n, C.minY = l, 0 == h.length || null == s && !u && i.align == OrgChart.CENTER) {
        var x = Math.ceil(t / y), _ = Math.ceil(e / y), w = 0, k = 0;
    ...
    if (d == OrgChart.action.insert || d == OrgChart.action.expand || d == OrgChart.action.collapse || d == OrgChart.action.update || d == OrgChart.action.centerNode) {
        var I = null;
        if (d == OrgChart.action.insert && c && null != c.insertedNodeId && null != c.insertedNodeId) I = g[c.insertedNodeId]; else if (d == OrgChart.action.update && c && null != c.visId && null != c.visId) I = g[c.visId]; else if (d != OrgChart.action.expand && d != OrgChart.action.collapse || !c || null == c.id || null == c.id) {
    ...
    for (var L = 0; L < h.length; L++) OrgChart.manager._iterate2(h[L], g, i, s, d, c, m, p, r, b);
    return {
        animations: b,
        boundary: C,
        viewBox: s,
    ...
    if (OrgChart.manager._isVisible(t, r, i, a)) {
        ...
        if (null != d && null != d.x && null != d.y) if (d.x != t.x || d.y != t.y) n && n.dragNodeIdList && -1 != n.dragNodeIdList.indexOf(t.id) || (h[0].push(t.id), h[1].push({transform: [1, 0, 0, 1, d.x, d.y]}), h[2].push({transform: [1, 0, 0, 1, t.x, t.y]}))
    }
    ...
    var l = e[o], s = a[o];
    if (!s) return {x: 0, y: 0};
    var h = null != s.movex ? s.movex : 0, d = null != s.movey ? s.movey : 0;
    ...
    if (3 == t.children.length) OrgChart.manager._verticalAssistantIterate(t.children[0], e), OrgChart.manager._verticalAssistantIterate(t.children[2], e), OrgChart.manager._verticalAssistantIterate(t.children[1], e); else for (r = 0; r < t.children.length; r++) OrgChart.manager._verticalAssistantIterate(t.children[r], e);
    ...
    var e = t.nodes;
    if ((t.groupDottedLines.length || t.dottedLines.length) && (e = JSON.parse(JSON.stringify(e))), t.groupDottedLines.length) for (var r = [], i = 0; i < t.groupDottedLines.length; i++) {
        var a = t.groupDottedLines[i];
        null == a.rootId && (a.rootId = a.to);
        var n = `balkan_group_dotted_${a.rootId}`;
        if (!r.has(n)) for (var o = 0; o < e.length; o++) if (e[o].id == a.rootId) {
        ...
        for (o = 0; o < e.length; o++) if (e[o].id == a.from) {
    ...
    if (t.dottedLines.length) for (i = 0; i < t.dottedLines.length; i++) {
        var h = t.dottedLines[i];
        null == h.rootId && (h.rootId = h.to);
        for (o = 0; o < e.length; o++) if (e[o].id == h.from) {
            var d;
            if ((d = JSON.parse(JSON.stringify(e[o]))).id = `balkan_dotted_${h.rootId}_balkan_id_${e[o].id}`, h.rootId == h.to ? d.pid = h.to : d.pid = `balkan_dotted_${h.rootId}_balkan_id_${h.to}`, d.tags || (d.tags = []), d.tags.push("boc-dotted-connector"), h.tags) for (s = 0; s < h.tags.length; s++) d.tags.push(h.tags[s]);
            e.push(d);
            break
        }
    }
    ...
    _defsIds: {}, defs: function (t) {
        ...
        var O = OrgChart._getPosition(r, t, a, n), v = "node";
        ...
        var l = t.lcn ? t.lcn : "base", s = e._layoutConfigs[l], h = OrgChart.t(t.templateName, t.min, r), d = [],
            c = [], g = s.levelSeparation / 2;
        t.layout > 0 && (g = s.mixedHierarchyNodesSeparation / 2);
        var p = 0, u = OrgChart.getRootOf(t).id, f = i[u][t.sl], m = void 0;
        if (t.hasPartners) {
            m = {
                ids: [],
                indexes: {},
        ...
        for (C = 0; C < t.children.length; C++) {
            var b, O = t.children[C], v = i[u][O.sl],
            ...
            if (O.isChildOfPartner) switch (s.orientation) {
                ...
                if ((w || O.layout > 1) && O.rightNeighbor && O.rightNeighbor.isSplit) switch (s.orientation) {
                    ...
                    case OrgChart.orientation.top:
                    case OrgChart.orientation.top_left:
                        if (1 == O.isPartner) y = OrgChart.ui._linkLeftToRight(t, O, h, p); else if (2 == O.isPartner) y = OrgChart.ui._linkRightToLeft(t, O, h, p); else {
                    ...
                    case OrgChart.orientation.right:
                    case OrgChart.orientation.right_top:
                        if (1 == O.isPartner) y = OrgChart.ui._linkTopToBottom(t, O, h, p); else if (2 == O.isPartner) y = OrgChart.ui._linkBottomToTop(t, O, h, p); else {
                            _ = 1 == O.layout ? void 0 : v.maxX - (v.maxX - f.minX) / 2;
            ...
            if (S) b = S, x = x.replaceAll("{rounded}", S).replaceAll("{edge}", S).replaceAll("{curve}", b); else if (-1 != x.indexOf("{rounded}")) if (y.xa == y.xb && y.xa == y.xc && y.xa == y.xd || y.ya == y.yb && y.ya == y.yc && y.ya == y.yd) b = "M" + y.xa + "," + y.ya + " L" + y.xd + "," + y.yd, x = x.replaceAll("{rounded}", b); else if (Math.abs(y.xa - y.xd) <= OrgChart.LINK_ROUNDED_CORNERS && Math.abs(y.xa - y.xc) <= OrgChart.LINK_ROUNDED_CORNERS && Math.abs(y.xa - y.xb) <= OrgChart.LINK_ROUNDED_CORNERS) b = "M" + y.xa + "," + y.ya + " L" + y.xa + "," + y.yd, x = x.replaceAll("{rounded}", b); else if (Math.abs(y.ya - y.yd) <= OrgChart.LINK_ROUNDED_CORNERS && Math.abs(y.ya - y.yc) <= OrgChart.LINK_ROUNDED_CORNERS && Math.abs(y.ya - y.yb) <= OrgChart.LINK_ROUNDED_CORNERS) b = "M" + y.xa + "," + y.ya + " L" + y.xd + "," + y.ya, x = x.replaceAll("{rounded}", b); else {
                var I = OrgChart.ui._roundedEdge(y.xa, y.ya, y.xb, y.yb, y.xc, y.yc),
                    A = OrgChart.ui._roundedEdge(y.xb, y.yb, y.xc, y.yc, y.xd, y.yd);
                b = "M" + I.x1 + "," + I.y1 + " " + I.x2 + "," + I.y2 + " Q" + I.qx1 + "," + I.qy1 + " " + I.qx2 + "," + I.qy2 + " L" + A.x2 + "," + A.y2 + " Q" + A.qx1 + "," + A.qy1 + " " + A.qx2 + "," + A.qy2 + " L" + A.x3 + "," + A.y3, x = x.replaceAll("{rounded}", b)
            } else -1 != x.indexOf("{edge}") ? (b = "M" + y.xa + "," + y.ya + " " + y.xb + "," + y.yb + " " + y.xc + "," + y.yc + " L" + y.xd + "," + y.yd, x = x.replaceAll("{edge}", b)) : -1 != x.indexOf("{curve}") ? (b = "M" + y.xa + "," + y.ya + " C" + y.xb + "," + y.yb + " " + y.xc + "," + y.yc + " " + y.xd + "," + y.yd, x = x.replaceAll("{curve}", b)) : (b = x.replaceAll("{xa}", y.xa).replaceAll("{ya}", y.ya).replaceAll("{xb}", y.xb).replaceAll("{yb}", y.yb).replaceAll("{xc}", y.xc).replaceAll("{yc}", y.yc).replaceAll("{xd}", y.xd).replaceAll("{yd}", y.yd), x = b);
            d.push(OrgChart.linkOpenTag.replaceAll("{id}", t.id).replaceAll("{class}", "link " + O.tags.join(" ")).replaceAll("{child-id}", O.id));
            var L = {node: t, cnode: O, p: y, html: x, action: n};
            ...
            for (var E in e.config.linkBinding) {
                var M = e.config.linkBinding[E], T = e._get(O.id);
                if (T) {
                    var B = T[M];
            ...
            if ("" != N) {
                var U = y.x, R = y.y;
                null != O.movey && (R += O.movey), N = OrgChart.linkFieldsOpenTag.replace("{x}", U).replace("{y}", R).replace("{rotate}", 0) + N + OrgChart.grCloseTag, d.push(N)
            }
        ...
        var o, l, s, h = OrgChart.LINK_ROUNDED_CORNERS, d = 0;
        ...
        if (!OrgChart._isMoved(r) && OrgChart._isMoved(e)) {
            ...
            switch (n) {
                case OrgChart.orientation.top:
                case OrgChart.orientation.top_left:
                    if (i.ya + a / 2 > i.yb) l = !0, s = i.xa < i.xd ? e.x + e.w + a / 2 : e.x - a / 2, h = e.y + e.h + a; else {
                        if (i.yb + a / 2 < i.yd) return null;
                        s = i.xa < i.xd ? r.x - a / 2 : r.x + r.w + a / 2, h = r.y - a / 2
                    }
                    break;
                case OrgChart.orientation.bottom:
                case OrgChart.orientation.bottom_left:
                    if (i.ya - a / 2 < i.yb) l = !0, s = i.xa < i.xd ? e.x + e.w + a / 2 : e.x - a / 2, h = e.y - a; else {
                        if (i.yb - a / 2 > i.yd) return null;
                        s = i.xa < i.xd ? r.x - a / 2 : r.x + r.w + a / 2, h = r.y + r.h + a / 2
                    }
                    break;
                case OrgChart.orientation.right:
                case OrgChart.orientation.right_top:
                    if (i.xa - a / 2 < i.xb) l = !0, h = i.ya < i.yd ? e.y + e.h + a / 2 : e.y - a / 2, s = e.x - a; else {
                        if (i.xb - a / 2 > i.xd) return null;
                        h = i.ya < i.yd ? r.y - a / 2 : r.y + r.h + a / 2, s = r.x + r.w + a / 2
                    }
                    break;
                case OrgChart.orientation.left:
                case OrgChart.orientation.left_top:
                    if (i.xa + a / 2 > i.xb) l = !0, h = i.ya < i.yd ? e.y + e.h + a / 2 : e.y - a / 2, s = e.x + e.w + a; else {
                        if (i.xb + a / 2 < i.xd) return null;
                        h = i.ya < i.yd ? r.y - a / 2 : r.y + r.h + a / 2, s = r.x - a / 2
                    }
            }
        ...
        if (OrgChart._isMoved(r) && OrgChart._isMoved(e)) {
            ...
            switch (n) {
                ...
                case OrgChart.orientation.top_left:
                    if (i.ya + a > i.yd) {
                        var s = i.xa < i.xd ? e.x + e.w + a / 2 : e.x - a / 2, h = e.y + e.h + a, d = r.y - a;
    ...
    } else s = i; else s = r / l; else s = e / o; else s = (h = e / o) > (d = r / l) ? d : h;
    ...
    var a, n, o = (new DOMParser).parseFromString(e, "text/xml").getElementsByTagName("text")[0],
        ...
        d = o.getAttribute(OrgChart.attr.width), c = o.getAttribute(OrgChart.attr.text_overflow),
    ...
    if (-1 != c.indexOf("multiline")) {
        ...
        for (var y = 1, x = !1, _ = 1; _ < C.length; _++) {
            var w = O.firstChild.data.length;
            if (O.firstChild.data += " " + C[_], O.getComputedTextLength() > d) {
                if (O.firstChild.data = O.firstChild.data.slice(0, w), y++, a && y > a) {
                ...
                (O = document.createElementNS(g, "tspan")).setAttributeNS(null, "x", l), O.setAttributeNS(null, "y", s + b * m), O.setAttributeNS(null, "text-anchor", h), v = document.createTextNode(C[_]), O.appendChild(v), p.appendChild(O), m++
            }
        }
        var S = "";
        if (null != p.innerHTML) S = p.innerHTML, p.innerHTML = ""; else {
            var I = "";
    ...
    } else if (navigator.msSaveBlob) navigator.msSaveBlob(n, r); else {
    ...
    for (var e = [], r = function (t) {
        ...
        return r + "\n"
    }, i = "", a = 0; a < t.length; a++) for (var n in t[a]) OrgChart._arrayContains(e, n) || (e.push(n), i += n + OrgChart.CSV_DELIMITER);
    ...
    function i(t, e, r) {
        var i = e.x - t.x, n = e.y - t.y, o = Math.sqrt(i * i + n * n);
    ...
    if ((this.config.mouseScrool == OrgChart.action.xScroll || this.config.mouseScrool == OrgChart.action.scroll) && this.bar) {
        var r = -1 !== navigator.userAgent.indexOf("Mac OS"), i = OrgChart._getScrollSensitivity();
        !function (t, i, a) {
            var n = !1;
            ...
            t.addEventListener("wheel", (function (t) {
                if (t.ctrlKey) return;
                var a = 0;
                if (e.config.mouseScrool == OrgChart.action.xScroll) (a = t.deltaX || t.wheelDeltaX) || (a = t.deltaY || t.wheelDeltaY); else if (e.config.mouseScrool == OrgChart.action.scroll && !(a = r || !t.shiftKey ? t.deltaX || t.wheelDeltaX : t.deltaY || t.wheelDeltaY)) return;
    ...
    if (this.bar) {
        ...
        this.bar.ignore = !0, this.bar.scrollLeft = n, this.position = this.bar.scrollLeft, this.bar.style.visibility = a <= 0 ? "hidden" : "", this.config.showXScroll !== OrgChart.scroll.visible && (this.bar.style.visibility = "hidden"), OrgChart.events.publish("change", [this, {isScrollBarVisible: "hidden" != this.bar.style.visibility}])
    }
    ...
    if ((this.config.mouseScrool == OrgChart.action.yScroll || this.config.mouseScrool == OrgChart.action.scroll) && this.bar) {
        ...
        !function (t, i, a) {
            ...
            t.addEventListener("wheel", (function (t) {
                if (t.ctrlKey) return;
                var a = 0;
                if (e.config.mouseScrool == OrgChart.action.yScroll) (a = t.deltaY || t.wheelDeltaY) || (a = t.deltaX || t.wheelDeltaX); else if (e.config.mouseScrool == OrgChart.action.scroll && !(a = r || !t.shiftKey ? t.deltaY || t.wheelDeltaY : t.deltaX || t.wheelDeltaX)) return;
                a = -a, a = Math.max(-1, Math.min(1, a)), e.position += -a * i;
    ...
    if (this.bar) {
        ...
        this.bar.ignore = !0, this.bar.scrollTop = n, this.position = this.bar.scrollTop, this.bar.style.visibility = a <= 0 ? "hidden" : "", this.config.showYScroll !== OrgChart.scroll.visible && (this.bar.style.visibility = "hidden"), OrgChart.events.publish("change", [this, {isScrollBarVisible: "hidden" != this.bar.style.visibility}])
    }
    ...
    var a, n, o, l = t.element.querySelector("#boc-ppdf-size"), s = t.element.querySelector("#boc-ppdf-layout"),
        h = t.element.querySelector("#boc-ppdf-scale"), d = t.element.querySelector("#boc-ppdf-margin"),
        c = t.element.querySelector("#boc-ppdf-header"), g = t.element.querySelector("#boc-ppdf-footer");
    l.value = e.format, s.value = e.landscape, h.value = e.scale, d.value = e.margin, c.value = e.header, g.value = e.footer, OrgChart.animate(t.element.querySelector("#boc-ppdf-btns"), {margin: [0, 0, 0, -250]}, {margin: [0, 0, 0, 0]}, 300, OrgChart.anim.outSin, (function () {
    ...
    if (t instanceof OrgChart && t.config.movable && i) for (var a = 0; a < i.length; a++) {
    ...
    for (var r = "", i = 0; i < this.config.clinks.length; i++) {
        var a = this.config.clinks[i], n = t.getNode(a.from), o = t.getNode(a.to);
        if (n && -1 != e.res.visibleNodeIds.indexOf(n.id) && (o && -1 != e.res.visibleNodeIds.indexOf(o.id))) {
            var l = n.x, s = n.y, h = o.x, d = o.y, c = {}, g = {}, p = l + n.w / 2, u = h + o.w / 2, f = s + n.h / 2,
                m = d + o.h / 2, C = 1;
            switch (this.config.orientation) {
                case OrgChart.orientation.top:
                case OrgChart.orientation.top_left:
        ...
        function _(t, e, r) {
            null == r && (r = 1);
            var i = e.x - t.x, n = e.y - t.y, o = Math.sqrt(Math.pow(e.x - t.x, 2) + Math.pow(e.y - t.y, 2)) / 3;
    ...
    var a = (r.x - e.x) / 2 + e.x, n = (r.y - e.y) / 2 + e.y;
    ...
    function n(e, n, o) {
        var s = [], h = null, d = "left", c = e.lcn ? e.lcn : "base", g = t._layoutConfigs[c];
        ...
        if (e.sl == n.sl) switch (h = n, g.orientation) {
            ...
            for (; null == h;) {
                var b = !1, O = m.parent, v = O.leftNeighbor, y = O.rightNeighbor;
        ...
        switch ((p = OrgChart.slinkTemplates[k]).labelPosition) {
            ...
            case"middle":
                ...
                S = s[L], I = s[L - 1], A = {x: (S[0] + I[0]) / 2, y: (S[1] + I[1]) / 2};
                break;
            case"end":
    ...
    if (e.node && e.node.tags && e.node.tags.has("group-dotted-lines")) {
        var r = t.getScale(), i = OrgChart.t(e.node.templateName, e.node.min, r), a = "";
    ...
    if (this.config.undoRedoStorageName) {
        ...
        if (0 != e) {
            ...
            var r = `${this.config.undoRedoStorageName}_undo_` + (e - 1), i = sessionStorage.getItem(r);
    ...
    if (this.config.undoRedoStorageName) {
        ...
        if (0 != e) {
            ...
            var r = `${this.config.undoRedoStorageName}_redo_` + (e - 1), i = sessionStorage.getItem(r);
            sessionStorage.removeItem(r);
            var a = JSON.parse(i);
            this.config.nodes = a.nodes, this.config.clinks = a.clinks, this.config.slinks = a.slinks, this.config.groupDottedLines = a.groupDottedLines, this.config.dottedLines = a.dottedLines, OrgChart.events.publish("updated", [this]), this.filterUI.update(), this.draw(OrgChart.action.update, void 0, t), this.undoRedoUI.refresh()
        }
    ...
    if (t.config.miniMap) {
        if (t.manager.action != OrgChart.action.move) {
            ...
            var i, a, n, o, l = t.element.querySelector('[data-id="mini-map-focus"]'), s = !1, h = null;
            l.onmousedown = function (t) {
                var e, n, o, h = l.getBoundingClientRect(), d = h.left, c = h.top;
                ...
                if (s) {
                    ...
                    var d = l.getBoundingClientRect(), c = d.left, g = d.top;
    ...
    var e = t.element.querySelector('[data-id="mini-map-main"]'), r = e.getContext("2d");
    OrgChart.miniMap._initCtx(t, e, 1);
    var i = 0, a = [];
    !function t(e, n) {
        if (Array.isArray(n)) for (var o = 0; o < n.length; o++) t(e, n[o]); else {
    ...
    if (!t.element.querySelector('[data-id="mini-map"]')) {
        ...
        var h = 0, d = 0, c = function (t) {
            var e = t.clientX - h, r = t.clientY - d;
    ...
    var l = [], s = e.toLowerCase(), h = s.split(" ");
    if (o && h.length > 1) {
        var d = h[0];
    ...
    for (var c = {}, g = 0; g < t.length; g++) for (var p = t[g], u = 0; u < r.length; u++) {
        var f = r[u];
    ...
    for (var o = a.length / 100, l = 0, s = 0, h = l > 0 ? 100 : 0, d = 0, c = 0; c < t.length; c++) for (var g = t[c], p = 0; p < n.length; p++) if (-1 != g.indexOf(n[p].searchPhrase)) {
        d++;
        break
    }
    ...
    if (n.length) {
        s = n[0].start;
        for (p = 0; p < n.length; p++) if (l += n[p].length, n[p].start < s && (s = n[p].start), p >= 1 && n[p - 1].start > n[p].start) {
            h = 0;
            break
        }
    }
    ...
    return a.doNotRender ? {html: ""} : {
        html: `<div class="boc-form-field" style="min-width: ${r};">\n                    <div class="boc-input" data-boc-input="" ${a.disabledAttribute} ${a.vlidators}>\n                        <label for="${a.id}">${OrgChart._escapeGreaterLessSign(a.label)}</label>\n                        <select class="multiple" data-binding="${OrgChart._escapeDoubleQuotes(a.binding)}" ${a.readOnlyAttribute} id="${a.id}" name="${a.id}" multiple>\n                            ${function () {
            for (var t = "", e = 0; e < a.options.length; e++) {
                var r = a.options[e];
                t += `<option ${a.value.includes(r.value) ? "selected" : ""} value="${OrgChart._escapeDoubleQuotes(r.value)}">${OrgChart._escapeGreaterLessSign(r.text)}</option>`
            }
            return t
        }()}                           \n                        </select>\n                    </div>\n                </div>`,
        id: a.id,
    ...
    for (i = 0; i < n.length; i++) {
        ...
        if ("checkbox" == l.type.toLowerCase()) o[s] = l.checked; else if (l.selectedOptions) {
    ...
    if (null !== this.filterBy || "object" != typeof this.instance.config.filterBy || Array.isArray(this.instance.config.filterBy) || (this.filterBy = JSON.parse(JSON.stringify(this.instance.config.filterBy))), null != this.filterBy) for (var e in this.filterBy) {
        var r = t[e];
        if (null != r) {
    ...
    if (this.instance.config.filterBy) {
        var t = {};
        if ("all" == this.instance.config.filterBy) for (var e = OrgChart.manager.getAllFields(this.instance.config), r = 0; r < e.length; r++) {
            var i = e[r];
            "tags" != i && "id" != i && "pid" != i && "ppid" != i && "stpid" != i && (t[i] = {})
        } else if (Array.isArray(this.instance.config.filterBy)) for (r = 0; r < this.instance.config.filterBy.length; r++) t[this.instance.config.filterBy[r]] = {}; else if ("object" == typeof this.instance.config.filterBy) for (var a in this.instance.config.filterBy) t[a] = {};
        for (var n in t) {
            var o = t[n];
        ...
        this.element.innerHTML = `<div>${c}</div>`, this.element.addEventListener("click", (function (t) {
            if (t.target.hasAttribute("data-filter-close") || t.target.hasAttribute("data-filter-field")) {
                    ...
                    for (i = 0; i < u.length; i++) u[i].addEventListener("change", (function (t) {
                        ...
                        if (e) {
                            ...
                            if (t.target.hasAttribute("data-all")) {
                                for (var i = t.target.parentNode.parentNode.querySelectorAll("input"), a = 0; a < i.length; a++) if (i[a] != t.target) for (var n in i[a].checked = t.target.checked, d.filterBy[r]) d.filterBy[r][n].checked = t.target.checked
                            } else if (null != d.filterBy[r][this.name] && (d.filterBy[r][this.name].checked = this.checked), this.checked) for (var o = d.instance.config.nodes, l = 0; l < o.length; l++) if (o[l][r] == this.name) for (var s = o[l]; s;) if (OrgChart.isNEU(s.stpid)) s = OrgChart.isNEU(s.pid) ? null : d.instance._get(s.pid); else if ((s = d.instance._get(s.stpid))[r]) {
                ...
                o.style.display = "block", t.target.classList.add("filter-field-selected"), (n = document.createElement("div")).classList.add("close"), n.innerHTML = "x", n.setAttribute("data-filter-close", ""), t.target.parentNode.appendChild(n), OrgChart.events.publish("show-items", [d, {name: e}])
            }
    ...
    return OrgChart.events.on(t, e, this._event_id), this
},OrgChart.filterUI.textFilterBy = "Filter by",void 0 === OrgChart && (OrgChart = {}),void 0 === OrgChart.remote && (OrgChart.remote = {}),OrgChart.LIMIT_NODES = !0,OrgChart.remote._fromResDTO = function (t, e, r, i, a) {
    var n = e[t.id];
